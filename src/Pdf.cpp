...
//   std::cout << "Instantiated specific template Pdf<Neutral::pi0,
//   Bachelor::pi, "
//                "Daughters::kpi>::Pdf()"
//             << "\n";
//   signalYield_ = std::unique_ptr<RooFormulaVar>(new RooFormulaVar(
//       "signalYield_pi0_pi_kpi", "Signal Yield pi0, pi, kpi",
//       "@0*(1-@1-@2)*@3",
//       RooArgList(SpecialisedVars<Neutral::pi0, Bachelor::pi,
//       Daughters::kpi>::Get().N_Dh(),
//                  NeutralDaughtersVars<Neutral::pi0,
//                  Daughters::kpi>::Get().selfCrossFeedRate(),
//                  NeutralDaughtersVars<Neutral::pi0,
//                  Daughters::kpi>::Get().crossFeedRate(),
//                  NeutralBachelorVars<Neutral::pi0,
//                  Bachelor::pi>::Get().bachEff())));
...
//       "crossFeedYield_pi0_pi_kpi", "Cross Feed Yield pi0, pi, kpi",
//       "@0*@1*@2",
//       RooArgList(
...
//       "bu2Dst0Hst_D0pi0Yield_pi0_pi_kpi", "bu2Dst0Hst_D0pi0 Yield pi0, pi,
//       kpi",
...
//       RooArgList(SpecialisedVars<Neutral::pi0, Bachelor::k,
//       Daughters::kpi>::Get().N_Dh(),
//                  NeutralDaughtersVars<Neutral::pi0,
//                  Daughters::kpi>::Get().selfCrossFeedRate(),
//                  NeutralDaughtersVars<Neutral::pi0,
...
//       "@0*@1*@2",
//       RooArgList(SpecialisedVars<Neutral::gamma, Bachelor::k,
//       Daughters::kpi>::Get().N_Dh(),
//                  NeutralDaughtersVars<Neutral::gamma,
//                  Daughters::kpi>::Get().crossFeedRate(),
//                  NeutralBachelorVars<Neutral::pi0,
//                  Bachelor::k>::Get().bachEff())));
//   bu2Dst0Hst_D0pi0Yield_ = std::unique_ptr<RooRealVar>(new RooRealVar(
//       "bu2Dst0Hst_D0pi0Yield_pi0_k_kpi", "bu2Dst0Hst_D0pi0 Yield pi0, k,
//       kpi",
//       NeutralVars<Neutral::pi0>::Get().bu2Dst0Hst_D0pi0Expected() *
...
//   // "@0*(1-@1)*@2",
//   //    RooArgList(
//   //        SpecialisedVars<Neutral::pi0, Bachelor::pi,
//   Daughters::kpi>::Get()
//   //            .N_Dh(),
//   //        NeutralDaughtersVars<Neutral::pi0,
//   Daughters::kpi>::Get().crossFeedRate(),
//   //        NeutralBachelorVars<Neutral::pi0,
//   Bachelor::k>::Get().missIdRate())));
//
//   CreateRooAddPdf();
// }
//
...
//           NeutralDaughtersVars<Neutral::gamma,
//           Daughters::kpi>::Get().crossFeedRate(),
//           NeutralBachelorVars<Neutral::gamma,
//           Bachelor::pi>::Get().bachEff())));
//   nonTmSignalYield_ = std::unique_ptr<RooFormulaVar>(new RooFormulaVar(
...
//       RooArgList(SpecialisedVars<Neutral::pi0, Bachelor::pi,
//       Daughters::kk>::Get().N_Dh(),
//                  NeutralDaughtersVars<Neutral::pi0,
//                  Daughters::kk>::Get().selfCrossFeedRate(),
//                  NeutralDaughtersVars<Neutral::pi0,
//                  Daughters::kk>::Get().crossFeedRate(),
//                  NeutralBachelorVars<Neutral::pi0,
//                  Bachelor::pi>::Get().bachEff())));
//   nonTmSignalYield_ = std::unique_ptr<RooFormulaVar>(new RooFormulaVar(
...
//           Bachelor::pi>::Get().bachEff())));
//   bu2Dst0Hst_D0pi0Yield_ = std::unique_ptr<RooRealVar>(new RooRealVar(
//       "bu2Dst0Hst_D0pi0Yield_pi0_pi_kk", "bu2Dst0Hst_D0pi0 Yield pi0, pi,
//       kk",
//       NeutralVars<Neutral::pi0>::Get().bu2Dst0Hst_D0pi0Expected() *
//           NeutralBachelorVars<Neutral::pi0, Bachelor::pi>::Get().bachelorSF()
//           *
...
//             << "\n";
//   signalYield_ = std::unique_ptr<RooFormulaVar>(new RooFormulaVar(
//       "signalYield_pi0_pi_pipi", "Signal Yield pi0, pi, pipi",
//       "@0*(1-@1-@2)*@3",
//       RooArgList(SpecialisedVars<Neutral::pi0, Bachelor::pi,
//       Daughters::pipi>::Get().N_Dh(),
//                  NeutralDaughtersVars<Neutral::pi0,
//                  Daughters::pipi>::Get().selfCrossFeedRate(),
//                  NeutralDaughtersVars<Neutral::pi0,
//                  Daughters::pipi>::Get().crossFeedRate(),
//                  NeutralBachelorVars<Neutral::pi0,
//                  Bachelor::pi>::Get().bachEff())));
//   nonTmSignalYield_ = std::unique_ptr<RooFormulaVar>(new RooFormulaVar(
...
//                  Bachelor::pi>::Get().bachEff())));
//   crossFeedYield_ = std::unique_ptr<RooFormulaVar>(new RooFormulaVar(
//       "crossFeedYield_pi0_pi_pipi", "Cross Feed Yield pi0, pi, pipi",
//       "@0*@1*@2",
//       RooArgList(
//           SpecialisedVars<Neutral::gamma, Bachelor::pi,
//           Daughters::pipi>::Get().N_Dh(),
...
//           Bachelor::pi>::Get().bachEff())));
//   bu2Dst0Hst_D0pi0Yield_ = std::unique_ptr<RooRealVar>(new RooRealVar(
//       "bu2Dst0Hst_D0pi0Yield_pi0_pi_pipi", "bu2Dst0Hst_D0pi0 Yield pi0, pi,
//       pipi",
//       NeutralVars<Neutral::pi0>::Get().bu2Dst0Hst_D0pi0Expected() *
//           NeutralBachelorVars<Neutral::pi0, Bachelor::pi>::Get().bachelorSF()
//           *
...
//   signalYield_ = std::unique_ptr<RooFormulaVar>(new RooFormulaVar(
//       "signalYield_pi0_k_pipi", "Signal Yield pi0, k, pipi",
//       "@0*(1-@1-@2)*@3",
//       RooArgList(SpecialisedVars<Neutral::pi0, Bachelor::k,
//       Daughters::pipi>::Get().N_Dh(),
//                  NeutralDaughtersVars<Neutral::pi0,
...
//                  Bachelor::k>::Get().bachEff())));
//   bu2Dst0Hst_D0pi0Yield_ = std::unique_ptr<RooRealVar>(new RooRealVar(
//       "bu2Dst0Hst_D0pi0Yield_pi0_k_pipi", "bu2Dst0Hst_D0pi0 Yield pi0, k,
//       pipi",
//       NeutralVars<Neutral::pi0>::Get().bu2Dst0Hst_D0pi0Expected() *
//           NeutralBachelorVars<Neutral::pi0, Bachelor::k>::Get().bachelorSF()
//           *
...
//           Bachelor::pi>::Get().bachEff())));
//   nonTmSignalYield_ = std::unique_ptr<RooFormulaVar>(new RooFormulaVar(
//       "nonTmSignalYield_gamma_pi_pipi", "non TM Signal Yield gamma, pi,
//       pipi",
//       "@0*@1*@2",
//       RooArgList(
//           SpecialisedVars<Neutral::gamma, Bachelor::pi,
...
//           Bachelor::pi>::Get().bachEff())));
//   bu2D0HstYield_ = std::unique_ptr<RooFormulaVar>(new RooFormulaVar(
//       "bu2D0HstYield_gamma_pi_pipi", "bu2D0Hst Yield gamma, pi, pipi",
//       "@0*@1",
//       RooArgList(
//           SpecialisedVars<Neutral::gamma, Bachelor::pi,
//           Daughters::pipi>::Get()
...
//       "@0*(1-@1)*@2",
//       RooArgList(
//           SpecialisedVars<Neutral::gamma, Bachelor::k,
//           Daughters::pipi>::Get()
//               .N_Dh(),
//           NeutralDaughtersVars<Neutral::gamma,
//           Daughters::pipi>::Get().crossFeedRate(),
...
//           Bachelor::k>::Get().bachEff())));
//   missIdYield_ = std::unique_ptr<RooRealVar>(
//       new RooRealVar("missIdYield_gamma_k_pipi", "missId yield gamma, k,
//       pipi",
//                      20 *
//                      DaughtersVars<Daughters::pipi>::Get().daughtersSF()));
//   // "@0*(1-@1)*@2",
...
//             << "\n";
//   signalYield_ = std::unique_ptr<RooFormulaVar>(new RooFormulaVar(
//       "signalYield_pi0_pi_pik", "Signal Yield pi0, pi, pik",
//       "@0*(1-@1-@2)*@3",
//       RooArgList(SpecialisedVars<Neutral::pi0, Bachelor::pi,
//       Daughters::pik>::Get().N_Dh(),
//                  NeutralDaughtersVars<Neutral::pi0,
//                  Daughters::pik>::Get().selfCrossFeedRate(),
//                  NeutralDaughtersVars<Neutral::pi0,
//                  Daughters::pik>::Get().crossFeedRate(),
//                  NeutralBachelorVars<Neutral::pi0,
//                  Bachelor::pi>::Get().bachEff())));
//   nonTmSignalYield_ = std::unique_ptr<RooFormulaVar>(new RooFormulaVar(
...
//                  Bachelor::pi>::Get().bachEff())));
//   crossFeedYield_ = std::unique_ptr<RooFormulaVar>(new RooFormulaVar(
//       "crossFeedYield_pi0_pi_pik", "Cross Feed Yield pi0, pi, pik",
//       "@0*@1*@2",
//       RooArgList(
//           SpecialisedVars<Neutral::gamma, Bachelor::pi,
//           Daughters::pik>::Get().N_Dh(),
...
//           Bachelor::pi>::Get().bachEff())));
//   bu2Dst0Hst_D0pi0Yield_ = std::unique_ptr<RooRealVar>(new RooRealVar(
//       "bu2Dst0Hst_D0pi0Yield_pi0_pi_pik", "bu2Dst0Hst_D0pi0 Yield pi0, pi,
//       pik",
//       NeutralVars<Neutral::pi0>::Get().bu2Dst0Hst_D0pi0Expected() *
//           NeutralBachelorVars<Neutral::pi0, Bachelor::pi>::Get().bachelorSF()
//           *
...
//                  Bachelor::k>::Get().bachEff())));
//   bu2Dst0Hst_D0pi0Yield_ = std::unique_ptr<RooRealVar>(new RooRealVar(
//       "bu2Dst0Hst_D0pi0Yield_pi0_k_pik", "bu2Dst0Hst_D0pi0 Yield pi0, k,
//       pik",
//       NeutralVars<Neutral::pi0>::Get().bu2Dst0Hst_D0pi0Expected() *
//           NeutralBachelorVars<Neutral::pi0, Bachelor::k>::Get().bachelorSF()
//           *
