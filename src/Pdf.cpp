...
Pdf::Pdf(Bachelor bachelor, Daughters daughters, RooRealVar &fitVariable)
    ...
    : bachelor_(bachelor), daughters_(daughters),
      ...
      signalSigma_("m[Bu]_Sigma", "m[Bu] signal sigma", 18, 15, 23),
      ...
      sigmaLeftNonTMSignal_("sigmaLeftNonTMSignal", "Non TM signal sigmaLeft", 52.6),
      sigmaRightNonTMSignal_("sigmaRightNonTMSignal", "Non TM signal sigmaRight", 49.4),
      meanCrossFeed_("meanCrossFeed", "Neutral cross feed mean", 5283),
      sigmaCrossFeed_("sigmaCrossFeed", "Neutral cross feed sigma", 80),
      ...
      sigmaBu2Dst0Hst_D0pi0_("sigmaBu2Dst0Hst_D0pi0", "Bu2Dst0Hst_D0pi0 sigma", 57.8),
      ...
      sigmaBu2Dst0Hst_D0gamma_("sigmaBu2Dst0Hst_D0gammai", "Bu2Dst0Hst_D0gamma sigma", 91.5),
