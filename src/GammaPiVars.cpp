...
NeutralBachelorVars<Neutral::gamma, Bachelor::pi>::NeutralBachelorVars(
    ...
    : uniqueId_(uniqueId),
      Bu2Dst0h_D0gamma_sigma1Bu_(Params::Get().CreateFloating(
          "Bu2Dst0h_D0gamma_sigma1Bu", uniqueId_, Neutral::gamma, Bachelor::pi,
          1.9997e+01, 15, 25)),
      ...
      Bu2Dst0h_D0gamma_sigmaBuPartial_(Params::Get().CreateFixed(
          ...
          Bachelor::pi, 3.0721e+01, 2.73e+00, Systematic::crossFeedBuPartialPdf,
          Sign::positive)),
      ...
      misId_Bu2Dst0h_D0gamma_sigma2Bu_(Params::Get().CreateFixed(
          "misId_Bu2Dst0h_D0gamma_sigma2Bu", uniqueId_, Neutral::gamma,
      ...
      misId_Bu2Dst0h_D0gamma_a1Bu_(Params::Get().CreateFixed(
          ...
          Bachelor::pi, 1.5478e-01, 1.46e-02, Systematic::misIdGammaPiPdfBu,
          Sign::positive)),
      ...
      misId_Bu2Dst0h_D0gamma_n1Bu_(Params::Get().CreateFixed(
          ...
          Bachelor::pi, 5.2558e-02, 2.08e-02, Systematic::misIdGammaPiPdfBu,
          Sign::positive)),
      ...
      Bu2Dst0h_D0pi0_sigma1BuPartial_(Params::Get().CreateFixed(
          ...
          Bachelor::pi, 2.5848e+01, 1.47e+00, Systematic::pi0BuPartialSigma1,
          Sign::positive)),
      ...
      misId_Bu2Dst0h_D0pi0_fracPdf1Delta_(Params::Get().CreateFixed(
          ...
          Bachelor::pi, 3.0797e-01, 0, Systematic::NA, Sign::positive)),
      ...
      misId_Bu2Dst0h_D0pi0_mean1Bu_(Params::Get().CreateFixed(
          ...
          Bachelor::pi, 5.2761e+03, 8.39e+00, Systematic::misIdPi0PiPdfBu,
          Sign::positive)),
      ...
      misId_Bu2Dst0h_D0pi0_sigma1Bu_(Params::Get().CreateFixed(
          ...
          Bachelor::pi, 5.3491e+01, 5.85e+00, Systematic::misIdPi0PiPdfBu,
          Sign::positive)),
      ...
      misId_Bu2Dst0h_D0pi0_a1Bu_(Params::Get().CreateFixed(
          ...
          7.5854e-01, 1.88e-01, Systematic::misIdPi0PiPdfBu, Sign::positive)),
      ...
      misId_Bu2Dst0h_D0pi0_mean1BuPartial_(Params::Get().CreateFixed(
          ...
          Bachelor::pi, 5.2385e+03, 3.59e+00,
      ...
      misId_Bu2Dst0h_D0pi0_fracPdf1BuPartial_(Params::Get().CreateFixed(
          ...
          Bachelor::pi, 3.7239e-01, 8.69e-02,
          Systematic::misIdPi0PiPdfBuPartial, Sign::positive)),
      ...
      buEffBu2Dst0h_D0gamma_(Params::Get().CreateFixed(
          ...
          ReturnBoxEffs(
              Mode::Bu2Dst0pi_D0gamma, Bachelor::pi, Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma,
                                             Bachelor::pi, Efficiency::buEffErr,
                                             false),
          Systematic::NA, Sign::positive)),
      deltaEffBu2Dst0h_D0pi0_(Params::Get().CreateFixed(
          ...
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0,
                                             Bachelor::pi,
      ...
      deltaEffBu2Dst0h_D0gamma_(Params::Get().CreateFixed(
          ...
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma,
                                             Bachelor::pi, Efficiency::deltaEff,
                                             false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma,
                                             Bachelor::pi,
                                             Efficiency::deltaEffErr, false),
      ...
      buPartialEffBu2Dst0h_D0pi0_(Params::Get().CreateFixed(
          ...
          ReturnBoxEffs(
              Mode::Bu2Dst0pi_D0pi0, Bachelor::pi, Efficiency::buPartialEffErr,
              false),
          Systematic::NA, Sign::positive)),
      ...
      mcEff_Bu2Dst0h_D0gamma_(Params::Get().CreateFixed(
          ...
          ReturnMCEffs(Mode::Bu2Dst0pi_D0gamma,
      ...
      mcEff_Bu2Dst0h_D0pi0_(Params::Get().CreateFixed(
          ...
          ReturnMCEffs(Mode::Bu2Dst0pi_D0pi0,
                                           Neutral::gamma, Bachelor::pi, true),
          ReturnMCEffs(Mode::Bu2Dst0pi_D0pi0,
                                           Neutral::gamma, Bachelor::pi, false),
          Systematic::mcEffs, Sign::positive)),
      ...
      mcEff_Bu2D0h_(Params::Get().CreateFixed(
          ...
          ReturnMCEffs(Mode::Bu2D0pi, Neutral::gamma,
                                           Bachelor::pi, true),
          ReturnMCEffs(Mode::Bu2D0pi, Neutral::gamma,
                                           Bachelor::pi, false),
          Systematic::mcEffs, Sign::positive)),
