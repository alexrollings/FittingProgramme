...
NeutralVars<Neutral::pi0>::NeutralVars(int uniqueId)
    ...
    : Bu2Dst0h_D0gamma_meanDelta_(("Bu2Dst0h_D0gamma_meanDelta_" +
      ...
      Bu2Dst0h_D0gamma_a1Delta_(
          ("Bu2Dst0h_D0gamma_a1Delta_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 1.5109e+00),
      Bu2Dst0h_D0gamma_a2Delta_(
          ("Bu2Dst0h_D0gamma_a2Delta_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", -5.7023e-01),
      Bu2Dst0h_D0gamma_n1Delta_(
          ("Bu2Dst0h_D0gamma_n1Delta_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 6.0060e+00),
      Bu2Dst0h_D0gamma_n2Delta_(
          ("Bu2Dst0h_D0gamma_n2Delta_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 7.8408e+00),
      ...
      Bu2Dst0h_D0gamma_meanBu_(
          ("Bu2Dst0h_D0gamma_meanBu_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
      ...
      Bu2Dst0h_D0gamma_a1Bu_(
          ("Bu2Dst0h_D0gamma_a1Bu_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 1.6184e+00),
      Bu2Dst0h_D0gamma_a2Bu_(
          ("Bu2Dst0h_D0gamma_a2Bu_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", -1.6623e+00),
      Bu2Dst0h_D0gamma_n1Bu_(
          ("Bu2Dst0h_D0gamma_n1Bu_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 8.6469e+00),
      Bu2Dst0h_D0gamma_n2Bu_(
          ("Bu2Dst0h_D0gamma_n2Bu_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 5.2563e+00),
      ...
      orEffBu2Dst0h_D0gamma_(
          ("orEffBu2Dst0h_D0gamma_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 1),
      boxEffBu2Dst0h_D0gamma_(
          ("boxEffBu2Dst0h_D0gamma_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 1),
      ...
      deltaCutEffBu2Dst0h_D0gamma_(("deltaCutEffBu2Dst0h_D0gamma_" +
                                    ComposeName(uniqueId, Neutral::pi0))
                                       .c_str(),
                                   "", 1),
      initYieldFAVBu2Dst0pi_D0gamma_(5.1958e+04),
      // -------------------- Bu2Dst0h_D0pi0 -------------------- //
      Bu2Dst0h_D0pi0_meanDelta_(
          ("Bu2Dst0h_D0pi0_meanDelta_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 8.6075e+01, 80, 90),
      Bu2Dst0h_D0pi0_sigmaDelta_(
          ("Bu2Dst0h_D0pi0_sigmaDelta_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 9.2845e+00, 2, 15),
      Bu2Dst0h_D0pi0_a1Delta_(
          ("Bu2Dst0h_D0pi0_a1Delta_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 4.2812e-01),
      Bu2Dst0h_D0pi0_a2Delta_(
          ("Bu2Dst0h_D0pi0_a2Delta_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", -7.3982e-01),
      Bu2Dst0h_D0pi0_n1Delta_(
          ("Bu2Dst0h_D0pi0_n1Delta_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 9.9912e+01),
      Bu2Dst0h_D0pi0_n2Delta_(
          ("Bu2Dst0h_D0pi0_n2Delta_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 7.0288e+00),
      ...
      Bu2Dst0h_D0pi0_meanBu_(
          ("Bu2Dst0h_D0pi0_meanBu_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 5.3431e+03),
      Bu2Dst0h_D0pi0_aBu_(
          ("Bu2Dst0h_D0pi0_aBu_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 9.8213e-01),
      Bu2Dst0h_D0pi0_nBu_(
          ("Bu2Dst0h_D0pi0_nBu_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 10),
      ...
      boxEffBu2Dst0h_D0pi0_(
          ("boxEffBu2Dst0h_D0pi0_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 1),
      ...
      initYieldFAVBu2Dst0pi_D0pi0_(initYieldFAVBu2Dst0pi_D0gamma_ *
                                   fracBu2Dst0pi_D0pi0_),
      // -------------------- MIS-REC -------------------- //
      ...
      MisRec_aBu_(
          ("MisRec_aBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(), "",
          2.6265e+00),
      MisRec_nBu_(
      ...
      buDeltaCutEffMisRec_(
          ...
          "", 1),
      deltaCutEffMisRec_(
          ("deltaCutEffMisRec_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 1),
      fracMisRec_Bu2Dst0pi_D0gamma_WN_(0.473),
      fracMisRec_Bu2Dst0pi_D0pi0_WN_(0.809),
      ...
      relativeBuWidth_Bu2D0h_(
          ("relativeBuWidth_Bu2D0hBu_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 0.95),
      Bu2D0h_aLBu_(
      ...
      buDeltaCutEffBu2D0h_(
          ...
          "", 1),
      deltaCutEffBu2D0h_(
          ("deltaCutEffBu2D0h_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          "", 1),
      fracBu2D0pi_(1.54),
  ...
  std::map<Mode, double> misRecModesMap = {
      {Mode::Bu2Dst0pi_D0pi0_WN, fracMisRec_Bu2Dst0pi_D0pi0_WN_ / fracMisRec_},
      {Mode::Bu2Dst0pi_D0gamma_WN,
       fracMisRec_Bu2Dst0pi_D0gamma_WN_ / fracMisRec_},
