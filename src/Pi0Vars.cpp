...
NeutralVars<Neutral::pi0>::NeutralVars(int uniqueId)
    ...
    : Bu2Dst0h_Dst02D0pi0_meanDelta_(("Bu2Dst0h_Dst02D0pi0_meanDelta_" +
      ...
      Bu2D0hst_thresholdDelta_(
          ("Bu2D0hst_thresholdDelta_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
      ...
      Bu2D0hst_a0MeanBu_(
          ("Bu2D0hst_a0MeanBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          ("a0 of mean of Bu2D0hst m[Bu] PDF " +
           ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          5.3577e+03),//, 4800, 5800),
      Bu2D0hst_a1MeanBu_(
          ("Bu2D0hst_a1MeanBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          ("a1 of mean of Bu2D0hst m[Bu] PDF " +
           ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          -3.6259e-02),
      Bu2D0hst_a2MeanBu_(),
      Bu2D0hst_meanBu_(
          ("Bu2D0hst_meanBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          ("Mean of Bu2D0hst m[Bu]" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          Configuration::Get().deltaMass(),
          RooArgList(Bu2D0hst_a0MeanBu_, Bu2D0hst_a1MeanBu_)),
      Bu2D0hst_a0SigmaBu_(
          ("Bu2D0hst_a0SigmaBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          ("a0 of sigma1 of Bu2D0hst m[Bu] PDF " +
           ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          -6.4972e+01),//, -100, 100),
      Bu2D0hst_a1SigmaBu_(
          ("Bu2D0hst_a1SigmaBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
      ...
      Bu2D0hst_a2SigmaBu_(),
      Bu2D0hst_aBu_(
          ("Bu2D0hst_aBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          ("a1 of Bu2D0hst " + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          1.7680e-04),
      Bu2D0hst_nBu_(
          ("Bu2D0hst_nBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          ("n1 of Bu2D0hst " + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          3.3954e-03),
      relativeBuWidth_Bu2D0hst_(
          ("relativeBuWidth_Bu2D0hst_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
      ...
      Bd2Dsth_a0MeanBu_(
          ("Bd2Dsth_a0MeanBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          ("a0 of mean of Bd2Dsth m[Bu] PDF " +
           ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          5.2558e+03),//, 4800, 5800),
      Bd2Dsth_a1MeanBu_(
          ("Bd2Dsth_a1MeanBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          ("a1 of mean of Bd2Dsth m[Bu] PDF " +
           ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          2.5728e-01),
      Bd2Dsth_a2MeanBu_(),
      Bd2Dsth_meanBu_(
          ("Bd2Dsth_meanBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          ("Mean of Bd2Dsth m[Bu]" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          Configuration::Get().deltaMass(),
          RooArgList(Bd2Dsth_a0MeanBu_, Bd2Dsth_a1MeanBu_)),
      Bd2Dsth_a0SigmaBu_(
          ("Bd2Dsth_a0SigmaBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          ("a0 of sigma1 of Bd2Dsth m[Bu] PDF " +
           ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
          -1.5319e+01, -30, -10),
      Bd2Dsth_a1SigmaBu_(
          ("Bd2Dsth_a1SigmaBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
      ...
      Bd2Dsth_a2SigmaBu_(),
      Bd2Dsth_aBu_(
          ("Bd2Dsth_aBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          ("a1 of Bd2Dsth " + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          3.3223e+00),
      Bd2Dsth_nBu_(
          ("Bd2Dsth_nBu_" + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          ("n1 of Bd2Dsth " + ComposeName(uniqueId, Neutral::pi0)).c_str(),
          1.2393e+00),
      relativeBuWidth_Bd2Dsth_(
          ("relativeBuWidth_Bd2Dsth_" + ComposeName(uniqueId, Neutral::pi0))
              .c_str(),
