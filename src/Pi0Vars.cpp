...
NeutralVars<Neutral::pi0>::NeutralVars(int uniqueId)
    : uniqueId_(uniqueId),
      ...
      Bu2Dst0h_D0pi0_KpiSigmaDelta_(Params::Get().CreateFixed(
          "Bu2Dst0h_D0pi0_KpiSigmaDelta", uniqueId_, Neutral::pi0, 1.0704e+00,
          4.22e-02, Systematic::Bu2Dst0h_D0pi0_PdfDelta_SigmaRatioKpi,
          Sign::same)),
      ...
      //     Sign::same)),
      Bu2Dst0h_D0pi0_a1Delta_(Params::Get().CreateFixed(
          "Bu2Dst0h_D0pi0_a1Delta", uniqueId_, Neutral::pi0, 6.9798e-01,
          4.70e-02, Systematic::Bu2Dst0h_D0pi0_PdfDelta_Tails, Sign::same)),
      ...
      //     Sign::same)),
      Bu2Dst0h_D0pi0_a2Delta_(Params::Get().CreateFixed(
          "Bu2Dst0h_D0pi0_a2Delta", uniqueId_, Neutral::pi0, -7.5337e-01,
          1.72e-02, Systematic::Bu2Dst0h_D0pi0_PdfDelta_Tails, Sign::same)),
      ...
      Bu2Dst0h_D0pi0_KpiSigmaBu_(Params::Get().CreateFixed(
          "Bu2Dst0h_D0pi0_KpiSigmaBu", uniqueId_, Neutral::pi0, 9.6840e-01,
          3.45e-02, Systematic::Bu2Dst0h_D0pi0_PdfBu_SigmaRatioKpi,
          Sign::same)),
      ...
      Bd2Dsth_KpiSigmaBu_(Params::Get().CreateFixed(
          ...
          Systematic::Bd2Dsth_PdfBu, Sign::same)),
      // Bd2Dsth_KpiSigmaBu_(Params::Get().CreateFloating(
      //     "Bd2Dsth_KpiSigmaBu", uniqueId_, Neutral::pi0, 0.95, 0.5, 1.5)),
      ...
      //     "Bu2D0hst_mean1Bu", uniqueId_, Neutral::pi0, Mode::Bu2D0rho, 5200,
      //     5300)),
      Bu2D0hst_mean1Bu_(Params::Get().CreateFixed(
          "Bu2D0hst_mean1Bu", uniqueId_, Neutral::pi0, 5.2529e+03,
          10, Systematic::Bu2D0hst_PdfBu, Sign::same)),
          // 6.15e+00, Systematic::Bu2D0hst_PdfBu, Sign::same)),
      ...
      //     "Bu2D0hst_KpiSigmaBu", uniqueId_, Neutral::pi0, 0.95, 0.5, 1.5)),
      ...
      orEffLb2Omegach_Lcpi0_(Params::Get().CreateFixed(
          "orEffLb2Omegach_Lcpi0", uniqueId_, Neutral::pi0,
      ...
      deltaEffLb2Omegach_Lcpi0_(Params::Get().CreateFixed(
          "deltaEffLb2Omegach_Lcpi0", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Lb2Omegacpi_Lcpi0, Bachelor::pi,
      ...
      buEffLb2Omegach_Lcpi0_(Params::Get().CreateFixed(
          "buEffLb2Omegach_Lcpi0", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Lb2Omegacpi_Lcpi0, Bachelor::pi,
      ...
      Bs2D0Kst0_sigma1BuPartial_(nullptr),
      Bs2D0Kst0_sigmaRatio21BuPartial_(nullptr),
      Bs2D0Kst0_sigma2BuPartial_(),
      Bs2D0Kst0_a1BuPartial_(nullptr),
      Bs2D0Kst0_n1BuPartial_(nullptr),
      Bs2D0Kst0_fracPdf1BuPartial_(nullptr),
      ...
      orEffBs2D0Kst0_(Params::Get().CreateFixed(
          "orEffBs2D0Kst0", uniqueId_, Neutral::pi0,
      ...
      deltaEffBs2D0Kst0_(Params::Get().CreateFixed(
          "deltaEffBs2D0Kst0", uniqueId_, Neutral::pi0,
      ...
      buEffBs2D0Kst0_(Params::Get().CreateFixed(
          "buEffBs2D0Kst0", uniqueId_, Neutral::pi0,
      ...
      fracKst0_Bs2Dst0Kpi_(Params::Get().CreateFixed(
          "fracKst0_Bs2Dst0Kpi", uniqueId_, Neutral::pi0,
      ...
      Bs2Dst0Kst0_D0pi0_a2BuPartial_(nullptr),
      Bs2Dst0Kst0_D0pi0_n2BuPartial_(nullptr),
      pdf1BuPartial_Bs2Dst0Kst0_D0pi0_(),
      pdf2BuPartial_Bs2Dst0Kst0_D0pi0_(),
      Bs2Dst0Kst0_D0pi0_fracPdf1BuPartial_(nullptr),
      pdfBuPartial_Bs2Dst0Kst0_D0pi0_(),
      // mcEff_Bs2Dst0Kst0_res_D0pi0_(Params::Get().CreateFixed(
      //     "mcEff_Bs2Dst0Kst0_res_D0pi0", uniqueId_, Neutral::pi0,
      ...
      orEffBs2Dst0Kst0_res_D0pi0_(Params::Get().CreateFixed(
          "orEffBs2Dst0Kst0_res_D0pi0", uniqueId_, Neutral::pi0,
      ...
      deltaEffBs2Dst0Kst0_res_D0pi0_(Params::Get().CreateFixed(
          "deltaEffBs2Dst0Kst0_res_D0pi0", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0, Bachelor::k,
                        Efficiency::deltaEff, false) +
              0.001,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0, Bachelor::k,
      ...
      buEffBs2Dst0Kst0_res_D0pi0_(Params::Get().CreateFixed(
          "buEffBs2Dst0Kst0_res_D0pi0", uniqueId_, Neutral::pi0,
          ...
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0, Bachelor::k,
                        Efficiency::buEffErr, false),
          Systematic::NA, Sign::same)),
      buPartialEffBs2Dst0Kst0_res_D0pi0_(nullptr),
      // mcEff_Bs2Dst0Kpi_D0pi0_(Params::Get().CreateFixed(
      //     "mcEff_Bs2Dst0Kpi_D0pi0", uniqueId_, Neutral::pi0,
      //     ReturnMCEffs(Mode::Bs2Dst0Kpi_D0pi0, Neutral::pi0, Bachelor::k,
      //                  Efficiency::mcEff),
      //     ReturnMCEffs(Mode::Bs2Dst0Kpi_D0pi0, Neutral::pi0, Bachelor::k,
      //                  Efficiency::mcEffErr),
      // Systematic::NA, Sign::same)),
      orEffBs2Dst0Kpi_D0pi0_(Params::Get().CreateFixed(
          "orEffBs2Dst0Kpi_D0pi0", uniqueId_, Neutral::pi0,
      ...
      deltaEffBs2Dst0Kpi_D0pi0_(Params::Get().CreateFixed(
          "deltaEffBs2Dst0Kpi_D0pi0", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0pi0, Bachelor::k,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0pi0, Bachelor::k,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBs2Dst0Kpi_D0pi0_(Params::Get().CreateFixed(
          "buEffBs2Dst0Kpi_D0pi0", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0pi0, Bachelor::k, Efficiency::buEff,
                        false),
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0pi0, Bachelor::k,
                        Efficiency::buEffErr, false),
          Systematic::NA, Sign::same)),
      buPartialEffBs2Dst0Kpi_D0pi0_(nullptr),
      ...
      //     "mcEff_Bs2Dst0Kst0_res_D0gamma", uniqueId_, Neutral::pi0,
      ...
      orEffBs2Dst0Kst0_res_D0gamma_(Params::Get().CreateFixed(
          "orEffBs2Dst0Kst0_res_D0gamma", uniqueId_, Neutral::pi0,
      ...
      deltaEffBs2Dst0Kst0_res_D0gamma_(Params::Get().CreateFixed(
          "deltaEffBs2Dst0Kst0_res_D0gamma", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma, Bachelor::k,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma, Bachelor::k,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBs2Dst0Kst0_res_D0gamma_(Params::Get().CreateFixed(
          "buEffBs2Dst0Kst0_res_D0gamma", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma, Bachelor::k,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma, Bachelor::k,
                        Efficiency::buEffErr, false),
          Systematic::NA, Sign::same)),
      buPartialEffBs2Dst0Kst0_res_D0gamma_(nullptr),
      // mcEff_Bs2Dst0Kpi_D0gamma_(Params::Get().CreateFixed(
      //     "mcEff_Bs2Dst0Kpi_D0gamma", uniqueId_, Neutral::pi0,
      //     ReturnMCEffs(Mode::Bs2Dst0Kpi_D0gamma, Neutral::pi0, Bachelor::k,
      //                  Efficiency::mcEff),
      //     ReturnMCEffs(Mode::Bs2Dst0Kpi_D0gamma, Neutral::pi0, Bachelor::k,
      //                  Efficiency::mcEffErr),
      //     Systematic::NA, Sign::same)),
      orEffBs2Dst0Kpi_D0gamma_(Params::Get().CreateFixed(
          "orEffBs2Dst0Kpi_D0gamma", uniqueId_, Neutral::pi0,
      ...
      deltaEffBs2Dst0Kpi_D0gamma_(Params::Get().CreateFixed(
          "deltaEffBs2Dst0Kpi_D0gamma", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0gamma, Bachelor::k,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0gamma, Bachelor::k,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBs2Dst0Kpi_D0gamma_(Params::Get().CreateFixed(
          "buEffBs2Dst0Kpi_D0gamma", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0gamma, Bachelor::k,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0gamma, Bachelor::k,
                        Efficiency::buEffErr, false),
          Systematic::NA, Sign::same)),
      buPartialEffBs2Dst0Kpi_D0gamma_(nullptr),
      ...
      //     ("mcEff_Bs2Dst0Kst0_D0gamma_" + ComposeName(uniqueId_,
      //     Neutral::pi0))
      //         .c_str(),
      //     "", "(@0*@1)+((1-@0)*@2)",
      ...
      orEffBs2Dst0Kst0_D0gamma_(
          ("orEffBs2Dst0Kst0_D0gamma_" + ComposeName(uniqueId_, Neutral::pi0))
              .c_str(),
          "", "(@0*@1)+((1-@0)*@2)",
      ...
      buEffBs2Dst0Kst0_D0gamma_(
          ("buEffBs2Dst0Kst0_D0gamma_" + ComposeName(uniqueId_, Neutral::pi0))
              .c_str(),
          "", "(@0*@1)+((1-@0)*@2)",
      ...
      orEffBs2Dst0Kst0_D0pi0_WN_(Params::Get().CreateFixed(
          "orEffBs2Dst0Kst0_D0pi0_WN", uniqueId_, Neutral::pi0,
      ...
      deltaEffBs2Dst0Kst0_D0pi0_WN_(Params::Get().CreateFixed(
          "deltaEffBs2Dst0Kst0_D0pi0_WN", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0_WN, Bachelor::k,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0_WN, Bachelor::k,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBs2Dst0Kst0_D0pi0_WN_(Params::Get().CreateFixed(
          "buEffBs2Dst0Kst0_D0pi0_WN", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0_WN, Bachelor::k,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0_WN, Bachelor::k,
                        Efficiency::buEffErr, false),
      ...
      Bs2Dst0Kst0_D0gamma_WN_meanBu_(
          Params::Get().CreateFixed("Bs2Dst0Kst0_D0gamma_WN_meanBu", uniqueId_,
                                    Neutral::pi0, Mode::Bs2Dst0Kst0_D0gamma_WN,
                                    Systematic::Bs2Dst0Kst0_WN, Sign::same)),
      Bs2Dst0Kst0_D0gamma_WN_sigmaBu_(
          Params::Get().CreateFixed("Bs2Dst0Kst0_D0gamma_WN_sigmaBu", uniqueId_,
                                    Neutral::pi0, Mode::Bs2Dst0Kst0_D0gamma_WN,
                                    Systematic::Bs2Dst0Kst0_WN, Sign::same)),
      ...
      orEffBs2Dst0Kst0_D0gamma_WN_(Params::Get().CreateFixed(
          "orEffBs2Dst0Kst0_D0gamma_WN", uniqueId_, Neutral::pi0,
      ...
      deltaEffBs2Dst0Kst0_D0gamma_WN_(Params::Get().CreateFixed(
          "deltaEffBs2Dst0Kst0_D0gamma_WN", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma_WN, Bachelor::k,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma_WN, Bachelor::k,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBs2Dst0Kst0_D0gamma_WN_(Params::Get().CreateFixed(
          "buEffBs2Dst0Kst0_D0gamma_WN", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma_WN, Bachelor::k,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma_WN, Bachelor::k,
                        Efficiency::buEffErr, false),
      ...
      Bs2Dst0Kst0_fracD0pi0_WN_Bu_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_fracD0pi0_WN_Bu", uniqueId_, Neutral::pi0,
          ReadPdfFracs<Neutral::pi0, Bachelor::k>("Bs2Dst0Kst0_fracD0pi0_WN_Bu",
                                                  ReturnType::val),
          ReadPdfFracs<Neutral::pi0, Bachelor::k>("Bs2Dst0Kst0_fracD0pi0_WN_Bu",
                                                  ReturnType::std),
          Systematic::Bs2Dst0Kst0_Frac, Sign::same)),
      ...
      buEffBs2Dst0Kst0_WN_(
          ("buEffBs2Dst0Kst0_WN_" + ComposeName(uniqueId_, Neutral::pi0))
              .c_str(),
          "@0*@1+(1-@0)*@2",
      ...
      orEffBu2Dst0h_D0pi0_D02pik_(Params::Get().CreateFixed(
          "orEffBu2Dst0h_D0pi0_D02pik", uniqueId_, Neutral::pi0,
      ...
      deltaEffBu2Dst0h_D0pi0_D02pik_(Params::Get().CreateFixed(
          "deltaEffBu2Dst0h_D0pi0_D02pik", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_D02pik, Bachelor::pi,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_D02pik, Bachelor::pi,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBu2Dst0h_D0pi0_D02pik_(Params::Get().CreateFixed(
          "buEffBu2Dst0h_D0pi0_D02pik", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_D02pik, Bachelor::pi,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_D02pik, Bachelor::pi,
                        Efficiency::buEffErr, false),
      ...
      orEffBu2Dst0h_D0pi0_WN_D02pik_(Params::Get().CreateFixed(
          "orEffBu2Dst0h_D0pi0_WN_D02pik", uniqueId_, Neutral::pi0,
      ...
      deltaEffBu2Dst0h_D0pi0_WN_D02pik_(Params::Get().CreateFixed(
          "deltaEffBu2Dst0h_D0pi0_WN_D02pik", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_WN_D02pik, Bachelor::pi,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_WN_D02pik, Bachelor::pi,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBu2Dst0h_D0pi0_WN_D02pik_(Params::Get().CreateFixed(
          "buEffBu2Dst0h_D0pi0_WN_D02pik", uniqueId_, Neutral::pi0,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_WN_D02pik, Bachelor::pi,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_WN_D02pik, Bachelor::pi,
                        Efficiency::buEffErr, false),
      ...
      //                                             Systematic::NA,
      //                                             Sign::same)),
      bkgFloatingFrac_Bu2Dst0h_D0gamma_WN_(
          Params::Get().CreateFloating("bkgFloatingFrac_Bu2Dst0h_D0gamma_WN",
                                       uniqueId_, Neutral::pi0, 1, 0, 5)),
      // bkgFloatingFrac_Bu2Dst0h_D0gamma_WN_(Params::Get().CreateFixed(
      //     "bkgFloatingFrac_Bu2Dst0h_D0gamma_WN", uniqueId_,
      //     Neutral::pi0, 1.0, 0.0, Systematic::NA, Sign::same)),
      ...
      //     "bkgFracFAV_Bd2Dsth", uniqueId_, Neutral::pi0,
      //     ReadBkgFracs<Neutral::pi0>(Mode::Bd2Dstpi, ReturnType::val), 0, Systematic::NA, Sign::none)),
      ...
      cpFrac_Bu2D0hst_(Params::Get().CreateFloating(
          "cpFrac_Bu2D0hst", uniqueId_, Neutral::pi0, 2, 0, 5)),
      ...
      bkgFracFAV_Bu2Dst0hst_(Params::Get().CreateFloating(
          "bkgFracFAV_Bu2Dst0hst", uniqueId_, Neutral::pi0,
          ReadBkgFracs<Neutral::pi0>(Mode::Bu2Dst0rho, ReturnType::val), 0, 5)),
      ...
      pdfBu_Bs2Dst0Kst0_(
          ...
          "", RooArgList(pdfBu_Bs2Dst0Kst0_WN_, pdfBu_Bs2Dst0Kst0_D0pi0_),
          Bs2Dst0Kst0_floatingFracWN_Bu_),
      ...
      buEffBs2Dst0Kst0_(
          ...
          // "@0",
          RooArgList(*Bs2Dst0Kst0_fracWN_, *bkgFracGlobal_WN_,
                     buEffBs2Dst0Kst0_D0pi0_, buEffBs2Dst0Kst0_WN_)),
      ...
      //     "fracPdfPeak_comb", uniqueId_, Neutral::pi0, 0.5, -1, 1)),
      deltaEff_comb_(Params::Get().CreateFixed(
          "deltaEff_comb", uniqueId_, Neutral::pi0,
