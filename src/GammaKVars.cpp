...
NeutralBachelorVars<Neutral::gamma, Bachelor::k>::NeutralBachelorVars(
    ...
    : uniqueId_(uniqueId),
      ...
      orEffMisId_Bu2Dst0h_D0gamma_(Params::Get().CreateFixed(
          "orEffMisId_Bu2Dst0h_D0gamma", uniqueId_, Neutral::gamma, Bachelor::k,
      ...
      orEffMisId_Bu2Dst0hst_D0pi0_(Params::Get().CreateFixed(
          "orEffMisId_Bu2Dst0hst_D0pi0", uniqueId_, Neutral::gamma, Bachelor::k,
      ...
      buEffMisId_Bu2Dst0h_D0gamma_(Params::Get().CreateFixed(
          "buEffMisId_Bu2Dst0h_D0gamma", uniqueId_, Neutral::gamma, Bachelor::k,
      ...
      buEffMisId_Bu2Dst0hst_D0pi0_(Params::Get().CreateFixed(
          "buEffMisId_Bu2Dst0hst_D0pi0", uniqueId_, Neutral::gamma, Bachelor::k,
  ...
  //   mcEff_Bu2Dst0h_D0gamma_->setVal(tmp_*0.9892);
  //   mcEff_Bu2Dst0h_D0gamma_WN_->setVal(tmp_*0.9888);
  //   mcEff_Bu2Dst0h_D0pi0_->setVal(tmp_*0.9882);
  //   mcEff_Bu2Dst0h_D0pi0_WN_->setVal(tmp_*0.9898);
  // }
}
