...
NeutralBachelorVars<Neutral::gamma, Bachelor::k>::NeutralBachelorVars(
    ...
    : Bu2Dst0h_Dst02D0gamma_sigma1Bu_(new RooFormulaVar(
      ...
      // -------------------- Bu2D0hst COMPONENT -------------------- //
      Bu2D0hst_sigmaBu_(new RooFormulaVar(
          ("Bu2D0hst_sigmaBu_" +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::k))
              .c_str(),
      ...
      pdf_Bu2D0hst_(
          ("pdf_Bu2D0hst_" + ComposeName(uniqueId, Neutral::gamma, Bachelor::k))
              .c_str(),
          ("Bu2D0hst 2D PDF " +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::k))
              .c_str(),
      ...
      pdf_Bd2Dsth_(
          ("pdf_Bd2Dsth_" + ComposeName(uniqueId, Neutral::gamma, Bachelor::k))
              .c_str(),
          ("Bd2Dsth 2D PDF " +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::k))
              .c_str(),
