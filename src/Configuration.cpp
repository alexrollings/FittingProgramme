...
Configuration::Configuration()
    : neutral_(),
      ...
      gammaCutString_(
          "bach_isMuon==0&&Bu_Delta_M>5050&&Bu_Delta_M<5500&&Delta_M>60&&Delta_M<190&&BDT1>0."
          "05&&BDT2>0.05&&D0h_M>4900&&D0_FD_ZSIG>2&&D0h_M<5200"),
      pi0CutString_(
          "bach_isMuon==0&&Bu_Delta_M>5050&&Bu_Delta_M<5450&&Delta_M>60&&Delta_M<190&&BDT1>0."
...
Systematic StringToEnum<Systematic>(std::string const &systematic) {
  ...
  } else if (systematic == "A_CP_K_Bu2Dst0hst") {
    return Systematic::A_CP_K_Bu2Dst0hst;
...
std::string EnumToString(Systematic systematic) {
  switch (systematic) {
    ...
    case Systematic::A_CP_K_Bu2Dst0hst:
      return "A_CP_K_Bu2Dst0hst";
