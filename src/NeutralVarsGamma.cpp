...
NeutralVars<Neutral::gamma>::NeutralVars(int uniqueId)
    ...
    : meanDelta_Bu2Dst0h_Dst02D0gamma_(
      ...
      sigmaRDelta_Bu2Dst0h_Dst02D0pi0_(("sigmaRDelta_Bu2Dst0h_Dst02D0pi0_" +
                                       ...
                                       ("Sigma right of Bu2Dst0h_Dst02D0pi0 " +
                                        ComposeName(uniqueId, Neutral::gamma))
                                           .c_str(),
                                       7.2062e+00),
      aLDelta_Bu2Dst0h_Dst02D0pi0_(("aLDelta_Bu2Dst0h_Dst02D0pi0_" +
                                    ComposeName(uniqueId, Neutral::gamma))
                                       .c_str(),
                                   ("aL of Bu2Dst0h_Dst02D0pi0 " +
                                    ComposeName(uniqueId, Neutral::gamma))
                                       .c_str(),
                                   -3.1226e+00),
      aRDelta_Bu2Dst0h_Dst02D0pi0_(("aRDelta_Bu2Dst0h_Dst02D0pi0_" +
                                    ComposeName(uniqueId, Neutral::gamma))
                                       .c_str(),
                                   ("aR of Bu2Dst0h_Dst02D0pi0 " +
                                    ComposeName(uniqueId, Neutral::gamma))
                                       .c_str(),
                                   4.6928e+00),
      nLDelta_Bu2Dst0h_Dst02D0pi0_(("nLDelta_Bu2Dst0h_Dst02D0pi0_" +
                                    ComposeName(uniqueId, Neutral::gamma))
                                       .c_str(),
                                   ("nL of Bu2Dst0h_Dst02D0pi0 " +
                                    ComposeName(uniqueId, Neutral::gamma))
                                       .c_str(),
                                   2.3440e+00),
      nRDelta_Bu2Dst0h_Dst02D0pi0_(("nRDelta_Bu2Dst0h_Dst02D0pi0_" +
                                    ComposeName(uniqueId, Neutral::gamma))
                                       .c_str(),
                                   ("nR of Bu2Dst0h_Dst02D0pi0 " +
                                    ComposeName(uniqueId, Neutral::gamma))
                                       .c_str(),
                                   5.1259e+01),
      pdfLDelta_Bu2Dst0h_Dst02D0pi0_(("pdfLDelta_Bu2Dst0h_Dst02D0pi0_" +
                                      ComposeName(uniqueId, Neutral::gamma))
                                         .c_str(),
                                     ...
                                     sigmaLDelta_Bu2Dst0h_Dst02D0pi0_,
                                     aLDelta_Bu2Dst0h_Dst02D0pi0_,
                                     nLDelta_Bu2Dst0h_Dst02D0pi0_),
      pdfRDelta_Bu2Dst0h_Dst02D0pi0_(("pdfRDelta_Bu2Dst0h_Dst02D0pi0_" +
                                      ComposeName(uniqueId, Neutral::gamma))
                                         .c_str(),
                                     ...
                                     Configuration::Get().deltaMass(),
                                     meanDelta_Bu2Dst0h_Dst02D0pi0_,
                                     sigmaRDelta_Bu2Dst0h_Dst02D0pi0_,
      ...
      a0Mean1Bu_overRec_(("a0Mean1Bu_overRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ...
                         // 5030, 4950, 5550),
                         5.2641e+03),
      a1Mean1Bu_overRec_(("a1Mean1Bu_overRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ...
                         // 3, 0, 10),
                         3.2770e+00),
      a2Mean1Bu_overRec_(("a2Mean1Bu_overRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
      ...
      mean1Bu_overRec_(
          ...
          RooArgList(a0Mean1Bu_overRec_, a1Mean1Bu_overRec_,
                     a2Mean1Bu_overRec_)),
      a0Mean2Bu_overRec_(("a0Mean2Bu_overRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ...
                         // 5030, 4950, 5550),
                         5.4396e+03),
      a1Mean2Bu_overRec_(("a1Mean2Bu_overRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ...
                         // 3, 0, 10),
                         -1.4957e-02),
      a2Mean2Bu_overRec_(("a2Mean2Bu_overRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
      ...
      mean2Bu_overRec_(
          ...
          RooArgList(a0Mean2Bu_overRec_, a1Mean2Bu_overRec_,
                     a2Mean2Bu_overRec_)),
      a0SigmaLBu_overRec_(("a0SigmaLBu_overRec_" +
                           ComposeName(uniqueId, Neutral::gamma))
                              .c_str(),
                          ...
                          // 32, -100, 100),
                          4.5119e+00),
      a1SigmaLBu_overRec_(("a1SigmaLBu_overRec_" +
                           ComposeName(uniqueId, Neutral::gamma))
                              .c_str(),
                          ...
                          // 0.09, -10, 10),
                          1.2461e-01),
      a2SigmaLBu_overRec_(("a2SigmaLBu_overRec_" +
                           ComposeName(uniqueId, Neutral::gamma))
                              .c_str(),
                          ...
                          // 0.0036, -0.01, 0.01),
                          1.8108e-03),
      a0SigmaRBu_overRec_(("a0SigmaRBu_overRec_" +
                           ComposeName(uniqueId, Neutral::gamma))
                              .c_str(),
                          ("a0 of sigmaR of overRec m[Bu] PDF " +
                           ComposeName(uniqueId, Neutral::gamma))
                              .c_str(),
                          -1.0667e+01),
      a1SigmaRBu_overRec_(("a1SigmaRBu_overRec_" +
                           ComposeName(uniqueId, Neutral::gamma))
                              .c_str(),
                          ("a1 of sigmaR of overRec m[Bu] PDF " +
                           ComposeName(uniqueId, Neutral::gamma))
                              .c_str(),
                          7.5421e-01),
      a2SigmaRBu_overRec_(("a2SigmaRBu_overRec_" +
                           ComposeName(uniqueId, Neutral::gamma))
                              .c_str(),
      ...
      nRBu_overRec_(
          ...
          3.7229e+01),  // 3.5, 0, 5),
      fracLRPdfBu_overRec_(("fracLRPdfBu_overRec_" +
                            ComposeName(uniqueId, Neutral::gamma))
                               .c_str(),
      ...
      sigmaLDelta_Bu2Dst0hst_Dst02D0gamma_(
          ...
          ("Sigma left of Bu2Dst0hst_Dst02D0gamma " +
           ComposeName(uniqueId, Neutral::gamma))
              .c_str(),
          1.4124e+00),
      // pdfDelta_Bu2Dst0hst_Dst02D0gamma_(("pdfDelta_Bu2Dst0hst_Dst02D0gamma_" +
      //                                    ComposeName(uniqueId, Neutral::gamma))
      //                                       .c_str(),
      ...
      sigmaRDelta_Bu2Dst0hst_Dst02D0gamma_(
          ...
          ("Sigma right of Bu2Dst0hst_Dst02D0gamma " +
           ComposeName(uniqueId, Neutral::gamma))
              .c_str(),
          1.3384e+01),
      aLDelta_Bu2Dst0hst_Dst02D0gamma_(("aLDelta_Bu2Dst0hst_Dst02D0gamma_" +
                                        ComposeName(uniqueId, Neutral::gamma))
                                           .c_str(),
                                       ("aL of Bu2Dst0hst_Dst02D0gamma " +
                                        ComposeName(uniqueId, Neutral::gamma))
                                           .c_str(),
                                       -1.3836e-01),
      aRDelta_Bu2Dst0hst_Dst02D0gamma_(("aRDelta_Bu2Dst0hst_Dst02D0gamma_" +
                                        ComposeName(uniqueId, Neutral::gamma))
                                           .c_str(),
                                       ("aR of Bu2Dst0hst_Dst02D0gamma " +
                                        ComposeName(uniqueId, Neutral::gamma))
                                           .c_str(),
                                       1.5977e+00),
      nLDelta_Bu2Dst0hst_Dst02D0gamma_(("nLDelta_Bu2Dst0hst_Dst02D0gamma_" +
                                        ComposeName(uniqueId, Neutral::gamma))
                                           .c_str(),
                                       ("nL of Bu2Dst0hst_Dst02D0gamma " +
                                        ComposeName(uniqueId, Neutral::gamma))
                                           .c_str(),
                                       1.0469e+02),
      nRDelta_Bu2Dst0hst_Dst02D0gamma_(("nRDelta_Bu2Dst0hst_Dst02D0gamma_" +
                                        ComposeName(uniqueId, Neutral::gamma))
                                           .c_str(),
      ...
      pdfLDelta_Bu2Dst0hst_Dst02D0gamma_(
          ...
          ("Bu2Dst0hst_Dst02D0gamma Delta left PDF " +
           ComposeName(uniqueId, Neutral::gamma))
              .c_str(),
          Configuration::Get().deltaMass(), meanDelta_Bu2Dst0hst_Dst02D0gamma_,
          sigmaLDelta_Bu2Dst0hst_Dst02D0gamma_,
          aLDelta_Bu2Dst0hst_Dst02D0gamma_, nLDelta_Bu2Dst0hst_Dst02D0gamma_),
      pdfRDelta_Bu2Dst0hst_Dst02D0gamma_(
          ...
          Configuration::Get().deltaMass(), meanDelta_Bu2Dst0hst_Dst02D0gamma_,
          sigmaRDelta_Bu2Dst0hst_Dst02D0gamma_,
          aRDelta_Bu2Dst0hst_Dst02D0gamma_, nRDelta_Bu2Dst0hst_Dst02D0gamma_),
      ...
      a0Sigma1Bu_misRec_(("a0Sigma1Bu_misRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ("a0 of sigma1 of misRec m[Bu] PDF " +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         -3.3548e+01),
      a1Sigma1Bu_misRec_(("a1Sigma1Bu_misRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ("a1 of sigma1 of misRec m[Bu] PDF " +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         7.0068e-01),
      a2Sigma1Bu_misRec_(("a2Sigma1Bu_misRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ("a2 of sigma1 of misRec m[Bu] PDF " +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         -8.3490e-04),
      a0Sigma2Bu_misRec_(("a0Sigma2Bu_misRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ("a0 of sigma2 of misRec m[Bu] PDF " +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         2.3523e+01),
      a1Sigma2Bu_misRec_(("a1Sigma2Bu_misRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ("a1 of sigma2 of misRec m[Bu] PDF " +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         -2.6007e-01),
      a2Sigma2Bu_misRec_(("a2Sigma2Bu_misRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ("a2 of sigma2 of misRec m[Bu] PDF " +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         -2.3067e-02),
      a0Sigma3Bu_misRec_(("a0Sigma3Bu_misRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ("a0 of sigma3 of misRec m[Bu] PDF " +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         5.1908e+01),
      a1Sigma3Bu_misRec_(("a1Sigma3Bu_misRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ("a1 of sigma3 of misRec m[Bu] PDF " +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         5.8331e-01),
      a2Sigma3Bu_misRec_(("a2Sigma3Bu_misRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ("a2 of sigma3 of misRec m[Bu] PDF " +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         -1.0471e-03),
      frac1PdfBu_misRec_(("frac1PdfBu_misRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ("Fraction of 1st CB Bu PDF in misRec " +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         9.2004e-02),
      frac2PdfBu_misRec_(("frac2PdfBu_misRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ("Fraction of 2nd CB Bu PDF in misRec " +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         3.4431e-04),
      frac3PdfBu_misRec_(("frac3PdfBu_misRec_" +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         ("Fraction of 3rd CB Bu PDF in misRec " +
                          ComposeName(uniqueId, Neutral::gamma))
                             .c_str(),
                         "1-(@0+@1)",
                         RooArgList(frac1PdfBu_misRec_, frac2PdfBu_misRec_)),
      relativeBuWidth_misRec_(("relativeBuWidth_misRec_" +
                               ComposeName(uniqueId, Neutral::gamma))
                                  .c_str(),
      ...
      pdf_Comb_(("pdf_Comb_" + ComposeName(uniqueId, Neutral::gamma)).c_str(),
                ("_Combinatorial PDF " + ComposeName(uniqueId, Neutral::gamma))
                    .c_str(),
                pdfDelta_Comb_,
                RooFit::Conditional(pdfBu_Comb_,
                                    Configuration::Get().buMass())) {
  std::cout << "\n\nPrinted in NVars: Signal mean:";
  meanDelta_Bu2Dst0h_Dst02D0gamma().Print();
  std::cout << "\n\nPrinted in NVars: Partial rec mean:";
  meanDelta_Bu2Dst0hst_Dst02D0gamma().Print();
}
