...
NeutralVars<Neutral::gamma>::NeutralVars()
    : meanCrossFeed_("meanBu2Dst0H_D0pi0_Gamma", "Gamma Bu2Dst0H_D0pi0 mean",
      ...
      relativeBd2DstHYield_("relativeBd2DstHYield_Gamma",
                            ...
                            0.23142),
      R_cp_("R_cp_Gamma", "R_dk_vs_dpi[kk]/R_dk_vs_dpi[kpi], Gamma", 1, 0.5,
            1.5) {}
...
NeutralVars<Neutral::pi0>::NeutralVars()
    : meanSignal_("meanBu2Dst0H_D0pi0_Pi0", "Pi0 Bu2Dst0H_D0pi0 mean",
      ...
      meanBu2D0H_1_(new RooRealVar("meanBu2D0H_1_Pi0", "Pi0 Bu2D0H mean 1", 5470, 5465, 5475)),
      ...
      relativeBu2D0HYield_(
          "relativeBu2D0HYield_Pi0",
          "Relative yield of Bu2D0H w.r.t. N_Dh, Pi0 mode", 0.10277),
      relativeBu2D0HstYield_(
          "relativeBu2D0HstYield_Pi0",
          "Relative yield of Bu2D0Hst w.r.t. N_Dh, Pi0 mode", 0.08897),
