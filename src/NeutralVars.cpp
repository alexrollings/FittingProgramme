...
NeutralVars<Neutral::gamma>::NeutralVars()
    : meanCrossFeed_("meanBu2Dst0H_D0pi0_Gamma",
      ...
      fullyReconstructedRate_("fullyReconstructedRate_Gamma", "Proportion of fully reconstructed signal in N_Dpi, Gamma", 0.5, 0, 1),
      selfCrossFeedRate_("selfCrossFeedRate_Gamma", "Proportion of SCF in N_Dpi, Gamma", 0.5, 0, 1),
      crossFeedRate_("crossFeedRate_Gamma", "Proportion of CF in N_Dpi, Gamma", 0.2, 0, 1),
      maxYield_(29000),
...
NeutralVars<Neutral::pi0>::NeutralVars()
    : meanSignal_("meanBu2Dst0H_D0pi0_Pi0", "Pi0 Bu2Dst0H_D0pi0 mean",
      ...
      fullyReconstructedRate_("fullyReconstructedRate_Pi0", "Proportion of fully reconstructed signal in N_Dpi, Pi0", 0.5, 0, 1),
      selfCrossFeedRate_("selfCrossFeedRate_Pi0", "Proportion of SCF in N_Dpi, Pi0", 0.5, 0, 1),
      crossFeedRate_("crossFeedRate_Pi0", "Proportion of CF in N_Dpi, Pi0", 0.2, 0, 1),
      maxYield_(27000),
