...
NeutralBachelorVars<Neutral::pi0, Bachelor::k>::NeutralBachelorVars(
    ...
    : Bu2Dst0h_D0pi0_sigmaBu_(new RooFormulaVar(
      ...
      misId_Bu2Dst0h_D0pi0_n2Bu_(Params::Get().CreateFixed(
          "misId_Bu2Dst0h_D0pi0_n2Bu", uniqueId, Neutral::pi0, Bachelor::k, 10,
          1, Systematic::NA, Sign::positive)),
      ...
      misId_Bu2Dst0h_D0pi0_fracPdf1Bu_(Params::Get().CreateFixed(
          "misId_Bu2Dst0h_D0pi0_fracPdf1Bu", uniqueId, Neutral::pi0,
          Bachelor::k, 1.6070e-01, 1.94e-02, Systematic::misIdPi0KPdfBu,
          Sign::positive)),
      ...
      misId_Bu2Dst0h_D0gamma_sigma1Bu_(Params::Get().CreateFixed(
          ...
          Bachelor::k, 3.7321e+01, 1.90e+00, Systematic::misIdGammaKPdfBu,
          Sign::positive)),
      misId_Bu2Dst0h_D0gamma_sigma2Bu_(Params::Get().CreateFixed(
          "misId_Bu2Dst0h_D0gamma_sigma2Bu", uniqueId, Neutral::pi0,
          Bachelor::k, 7.3708e+01, 2.55e+00, Systematic::misIdGammaKPdfBu,
          Sign::positive)),
      ...
      misId_MisRec_a1Bu_(Params::Get().CreateFixed(
          "misId_MisRec_a1Bu", uniqueId, Neutral::pi0, Bachelor::k, 2.5413e-01,
          6.21e-03, Systematic::misIdMisRecKPdfBu, Sign::positive)),
      misId_MisRec_a2Bu_(nullptr),
      misId_MisRec_n1Bu_(Params::Get().CreateFixed(
          "misId_MisRec_n1Bu", uniqueId, Neutral::pi0, Bachelor::k, 2.4686e-01,
      ...
      mcEff_Bu2D0h_(Params::Get().CreateFixed(
          "mcEff_Bu2D0h", uniqueId, Neutral::pi0, Bachelor::k,
          Configuration::Get().ReturnMCEff(Mode::Bu2D0K, Neutral::pi0,
                                           Bachelor::k, true),
          Configuration::Get().ReturnMCEff(Mode::Bu2D0K, Neutral::pi0,
                                           Bachelor::k, false),
          Systematic::mcEffs, Sign::positive)),
      ...
      misId_PartRec_aLBu_(Params::Get().CreateFixed(
          "misId_PartRec_aLBu", uniqueId, Neutral::pi0, Bachelor::k, 1.8171e-09,
          3.43e-02, Systematic::misIdPartRecKPdfBu, Sign::positive)),
      misId_PartRec_aRBu_(Params::Get().CreateFixed(
          "misId_PartRec_aRBu", uniqueId, Neutral::pi0, Bachelor::k, 2.1857e-01,
      ...
      Bs2Dst0Kpi_thresholdDelta_(Params::Get().CreateFixed(
          "Bs2Dst0Kpi_thresholdDelta", uniqueId, Neutral::pi0, Bachelor::k,
          1.3627e+02, 1e00, Systematic::NA, Sign::positive)),
      Bs2Dst0Kpi_aDelta_(Params::Get().CreateFixed(
          "Bs2Dst0Kpi_aDelta", uniqueId, Neutral::pi0, Bachelor::k, -7.8318e+00,
          1e00, Systematic::NA, Sign::none)),
      Bs2Dst0Kpi_bDelta_(Params::Get().CreateFixed(
          "Bs2Dst0Kpi_bDelta", uniqueId, Neutral::pi0, Bachelor::k, 7.3621e-02,
          1e00, Systematic::NA, Sign::none)),
      Bs2Dst0Kpi_cDelta_(Params::Get().CreateFixed(
          "Bs2Dst0Kpi_cDelta", uniqueId, Neutral::pi0, Bachelor::k, 1.5459e+01,
      ...
      Bs2Dst0Kpi_meanDeltaPi0_(Params::Get().CreateFixed(
          "Bs2Dst0Kpi_meanDeltaPi0", uniqueId, Neutral::pi0, Bachelor::k,
          1.4249e+02, 2.88e-01, Systematic::Bs2Dst0KpiDeltaPdf,
          Sign::positive)),
      Bs2Dst0Kpi_sigmaDeltaPi0_(Params::Get().CreateFixed(
          "Bs2Dst0Kpi_sigmaDeltaPi0", uniqueId, Neutral::pi0, Bachelor::k,
      ...
      Bs2Dst0Kpi_fracPeakDeltaPi0_(Params::Get().CreateFixed(
          "Bs2Dst0Kpi_fracPeakDeltaPi0", uniqueId, Neutral::pi0, Bachelor::k,
      ...
      Bs2D0Kpi_thresholdDelta_(Params::Get().CreateFixed(
          "Bs2D0Kpi_thresholdDelta", uniqueId, Neutral::pi0, Bachelor::k,
          1.3627e+02, 1e00, Systematic::NA, Sign::positive)),
      Bs2D0Kpi_aDelta_(Params::Get().CreateFixed(
          "Bs2D0Kpi_aDelta", uniqueId, Neutral::pi0, Bachelor::k, -4.4722e+00,
          2.09e+00, Systematic::Bs2D0KpiDeltaPdf, Sign::none)),
      Bs2D0Kpi_bDelta_(Params::Get().CreateFixed(
          "Bs2D0Kpi_bDelta", uniqueId, Neutral::pi0, Bachelor::k, 7.3621e-02,
          1e00, Systematic::NA, Sign::none)),
  ...
  buDeltaCutEffMisId_MisRec_ =
      std::shared_ptr<RooRealVar>(Params::Get().CreateFixed(
          "buDeltaCutEffMisId_MisRec", uniqueId, Neutral::pi0,
          mapMisId_MisRec["buDeltaCutEff"],
          mapMisId_MisRec["buDeltaCutEffErr"],
          Systematic::buDeltaMisIdCutEffs, Sign::positive));
  deltaCutEffMisId_MisRec_ =
      std::shared_ptr<RooRealVar>(Params::Get().CreateFixed(
          "deltaCutEffMisId_MisRec", uniqueId, Neutral::pi0,
          mapMisId_MisRec["deltaCutEff"],
  ...
  buDeltaCutEffMisId_Bu2D0h_ =
      std::shared_ptr<RooRealVar>(Params::Get().CreateFixed(
          "buDeltaCutEffMisId_Bu2D0h", uniqueId, Neutral::pi0,
          mapMisId_Bu2D0h["buDeltaCutEff"],
          mapMisId_Bu2D0h["buDeltaCutEffErr"],
          Systematic::NA, Sign::positive));
  deltaCutEffMisId_Bu2D0h_ =
      std::shared_ptr<RooRealVar>(Params::Get().CreateFixed(
          "deltaCutEffMisId_Bu2D0h", uniqueId, Neutral::pi0,
          mapMisId_Bu2D0h["deltaCutEff"],
          mapMisId_Bu2D0h["deltaCutEffErr"],
          Systematic::NA, Sign::positive));

  std::map<std::string, double> mapMisId_PartRec;
  Configuration::Get().ReturnBoxEffs(Mode::Bu2Dst0rho_D0pi0, Bachelor::k,
                                     mapMisId_PartRec, true);
  buDeltaCutEffMisId_PartRec_ =
      std::shared_ptr<RooRealVar>(Params::Get().CreateFixed(
          "buDeltaCutEffMisId_PartRec", uniqueId, Neutral::pi0,
          mapMisId_PartRec["buDeltaCutEff"],
          mapMisId_PartRec["buDeltaCutEffErr"],
          Systematic::buDeltaMisIdCutEffs, Sign::positive));
  deltaCutEffMisId_PartRec_ =
      std::shared_ptr<RooRealVar>(Params::Get().CreateFixed(
          "deltaCutEffMisId_PartRec", uniqueId, Neutral::pi0,
          mapMisId_PartRec["deltaCutEff"],
          mapMisId_PartRec["deltaCutEffErr"],
          Systematic::deltaMisIdCutEffs, Sign::positive));
