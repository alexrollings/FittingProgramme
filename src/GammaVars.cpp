...
NeutralVars<Neutral::gamma>::NeutralVars(int uniqueId)
    ...
    : Bu2Dst0h_Dst02D0gamma_meanDelta_(
          ("Bu2Dst0h_Dst02D0gamma_mean_" +
           ComposeName(uniqueId, Variable::delta, Neutral::gamma))
              .c_str(),
          "", 1.4233e+02),
      ...
      pdf1Delta_Bu2Dst0h_Dst02D0gamma_(
          ...
          Bu2Dst0h_Dst02D0gamma_meanDelta_, Bu2Dst0h_Dst02D0gamma_sigma1Delta_,
      ...
      pdf2Delta_Bu2Dst0h_Dst02D0gamma_(
          ("pdf2_Bu2Dst0h_Dst02D0gamma_" +
           ComposeName(uniqueId, Variable::delta, Neutral::gamma))
              .c_str(),
          "", Configuration::Get().deltaMass(),
          Bu2Dst0h_Dst02D0gamma_meanDelta_, Bu2Dst0h_Dst02D0gamma_sigma2Delta_,
