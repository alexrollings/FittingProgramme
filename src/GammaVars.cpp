...
NeutralVars<Neutral::gamma>::NeutralVars(int uniqueId)
    : uniqueId_(uniqueId),
      ...
      // Bu2Dst0h_D0gamma_WN_KpiSigmaBuPartial_(Params::Get().CreateFloating(
      //     "Bu2Dst0h_D0gamma_WN_KpiSigmaBuPartial", uniqueId_, Neutral::gamma,
      //     1.0, 0.5, 1.5)),
      ...
      //     "Bu2Dst0h_D0pi0_WN_KpiSigmaBuPartial", uniqueId_,
      //     Neutral::gamma, 1.0, 0.5, 1.5)),
      ...
      Bu2D0hst_KpiSigmaBu_(Params::Get().CreateFixed(
          ...
          Systematic::Bu2D0hst_PdfBu, Sign::same)),
      // Bu2D0hst_KpiSigmaBu_(Params::Get().CreateFloating(
      //     "Bu2D0hst_KpiSigmaBu", uniqueId_, Neutral::gamma, 1.0, 0.5, 1.5)),
      ...
      Bu2D0hst_KpiSigmaBuPartial_(Params::Get().CreateFixed(
          ...
          Systematic::Bu2D0hst_PdfBuPartial, Sign::same)),
      // Bu2D0hst_KpiSigmaBuPartial_(Params::Get().CreateFloating(
      //     "Bu2D0hst_KpiSigmaBuPartial", uniqueId_, Neutral::gamma, 1.0,
      //     0.5, 1.5)),
      // -------------------- Bu2Dst0hst_D0gamma -------------------- //
      ...
      Bu2Dst0hst_D0gamma_mean1Bu_(Params::Get().CreateFixed(
          "Bu2Dst0hst_D0gamma_mean1Bu", uniqueId_, Neutral::gamma, 5.1037e+03,
          20, Systematic::Bu2Dst0hst_D0gamma_PdfBu,
          Sign::same)),  // 1.76e+00
      ...
      Bu2Dst0hst_D0gamma_fracPdf1Bu_(Params::Get().CreateFixed(
          "Bu2Dst0hst_D0gamma_fracPdf1Bu", uniqueId, Neutral::gamma, 5.7343e-01,
          0.2, Systematic::Bu2Dst0hst_D0gamma_PdfBu,
          Sign::same)),  // 2.63e-02
      ...
      //     Sign::same)),
      // Bu2Dst0hst_D0pi0_meanBuPartial_(Params::Get().CreateFloating(
      //     "Bu2Dst0hst_D0pi0_meanBuPartial", uniqueId_, Neutral::gamma,
      //     Mode::Bu2Dst0rho_D0pi0, 5135, 5155)),
      Bu2Dst0hst_D0pi0_meanBuPartial_(Params::Get().CreateFixed(
          "Bu2Dst0hst_D0pi0_meanBuPartial", uniqueId_, Neutral::gamma,
          5.1477e+03, 3, Systematic::Bu2Dst0hst_D0pi0_PdfBuPartial,
          Sign::same)),  // 1.54e+00
      ...
      buEffLb2Omegach_Lcpi0_(Params::Get().CreateFixed(
          "buEffLb2Omegach_Lcpi0", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Lb2Omegacpi_Lcpi0, Bachelor::pi,
      ...
      buPartialEffLb2Omegach_Lcpi0_(Params::Get().CreateFixed(
          "buPartialEffLb2Omegach_Lcpi0", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Lb2Omegacpi_Lcpi0, Bachelor::pi,
      ...
      orEffBs2D0Kst0_(Params::Get().CreateFixed(
          "orEffBs2D0Kst0", uniqueId_, Neutral::gamma,
      ...
      buEffBs2D0Kst0_(Params::Get().CreateFixed(
          "buEffBs2D0Kst0", uniqueId_, Neutral::gamma,
      ...
      buPartialEffBs2D0Kst0_(Params::Get().CreateFixed(
          "buPartialEffBs2D0Kst0", uniqueId_, Neutral::gamma,
      ...
      Bs2Dst0Kst0_D0pi0_meanBuPartial_(Params::Get().CreateFixed(
          ...
          Mode::Bs2Dst0Kst0_D0pi0, Systematic::NA, Sign::same)),
      ...
      Bs2Dst0Kst0_D0pi0_a1BuPartial_(Params::Get().CreateFixed(
          ...
          Mode::Bs2Dst0Kst0_D0pi0, Systematic::NA, Sign::none)),
      Bs2Dst0Kst0_D0pi0_n1BuPartial_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0pi0_n1BuPartial", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0pi0, Systematic::NA, Sign::none)),
      Bs2Dst0Kst0_D0pi0_a2BuPartial_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0pi0_a2BuPartial", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0pi0, Systematic::NA, Sign::none)),
      Bs2Dst0Kst0_D0pi0_n2BuPartial_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0pi0_n2BuPartial", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0pi0, Systematic::NA, Sign::none)),
      Bs2Dst0Kst0_D0pi0_fracPdf1BuPartial_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0pi0_fracPdf1BuPartial", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0pi0, Systematic::NA, Sign::none)),
      pdf1BuPartial_Bs2Dst0Kst0_D0pi0_(
          ("pdf1BuPartial_Bs2Dst0Kst0_D0pi0_" +
           ComposeName(uniqueId_, Neutral::gamma))
              .c_str(),
          "", Configuration::Get().buDeltaMass(),
      ...
      pdf2BuPartial_Bs2Dst0Kst0_D0pi0_(
          ("pdf2BuPartial_Bs2Dst0Kst0_D0pi0_" +
           ComposeName(uniqueId_, Neutral::gamma))
              .c_str(),
          "", Configuration::Get().buDeltaMass(),
          *Bs2Dst0Kst0_D0pi0_meanBuPartial_, *Bs2Dst0Kst0_D0pi0_sigmaBuPartial_,
          *Bs2Dst0Kst0_D0pi0_a2BuPartial_, *Bs2Dst0Kst0_D0pi0_n2BuPartial_),
      pdfBuPartial_Bs2Dst0Kst0_D0pi0_(
          ("pdfBuPartial_Bs2Dst0Kst0_D0pi0_" +
           ComposeName(uniqueId_, Neutral::gamma))
              .c_str(),
          "",
          RooArgList(pdf1BuPartial_Bs2Dst0Kst0_D0pi0_,
                     pdf2BuPartial_Bs2Dst0Kst0_D0pi0_),
          *Bs2Dst0Kst0_D0pi0_fracPdf1BuPartial_),
      // mcEff_Bs2Dst0Kst0_res_D0pi0_(Params::Get().CreateFixed(
      //     "mcEff_Bs2Dst0Kst0_res_D0pi0", uniqueId_, Neutral::gamma,
      ...
      orEffBs2Dst0Kst0_res_D0pi0_(Params::Get().CreateFixed(
          "orEffBs2Dst0Kst0_res_D0pi0", uniqueId_, Neutral::gamma,
      ...
      deltaEffBs2Dst0Kst0_res_D0pi0_(Params::Get().CreateFixed(
          "deltaEffBs2Dst0Kst0_res_D0pi0", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0, Bachelor::k,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0, Bachelor::k,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBs2Dst0Kst0_res_D0pi0_(Params::Get().CreateFixed(
          "buEffBs2Dst0Kst0_res_D0pi0", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0, Bachelor::k, Efficiency::buEff,
                        false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0, Bachelor::k,
                        Efficiency::buEffErr, false),
          Systematic::NA, Sign::same)),
      buPartialEffBs2Dst0Kst0_res_D0pi0_(Params::Get().CreateFixed(
          "buPartialEffBs2Dst0Kst0_res_D0pi0", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0, Bachelor::k,
                        Efficiency::buPartialEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0, Bachelor::k,
                        Efficiency::buPartialEffErr, false),
          Systematic::NA, Sign::same)),
      // mcEff_Bs2Dst0Kpi_D0pi0_(Params::Get().CreateFixed(
      //     "mcEff_Bs2Dst0Kpi_D0pi0", uniqueId_, Neutral::gamma,
      ...
      orEffBs2Dst0Kpi_D0pi0_(Params::Get().CreateFixed(
          "orEffBs2Dst0Kpi_D0pi0", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0pi0, Bachelor::k, Efficiency::orEff,
                        false),
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0pi0, Bachelor::k,
                        Efficiency::orEffErr, false),
          Systematic::NA, Sign::same)),
      deltaEffBs2Dst0Kpi_D0pi0_(Params::Get().CreateFixed(
          "deltaEffBs2Dst0Kpi_D0pi0", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0pi0, Bachelor::k,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0pi0, Bachelor::k,
                        Efficiency::deltaEffErr, false),
          Systematic::NA, Sign::same)),
      buEffBs2Dst0Kpi_D0pi0_(Params::Get().CreateFixed(
          "buEffBs2Dst0Kpi_D0pi0", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0pi0, Bachelor::k, Efficiency::buEff,
                        false),
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0pi0, Bachelor::k,
                        Efficiency::buEffErr, false),
          Systematic::NA, Sign::same)),
      buPartialEffBs2Dst0Kpi_D0pi0_(Params::Get().CreateFixed(
          "buPartialEffBs2Dst0Kpi_D0pi0", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0pi0, Bachelor::k,
                        Efficiency::buPartialEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0pi0, Bachelor::k,
                        Efficiency::buPartialEffErr, false),
      ...
      //               *mcEff_Bs2Dst0Kpi_D0pi0_)),
      orEffBs2Dst0Kst0_D0pi0_(
          ("orEffBs2Dst0Kst0_D0pi0_" + ComposeName(uniqueId_, Neutral::gamma))
              .c_str(),
          "", "(@0*@1)+((1-@0)*@2)",
          RooArgSet(*fracKst0_Bs2Dst0Kpi_, *orEffBs2Dst0Kst0_res_D0pi0_,
                    *orEffBs2Dst0Kpi_D0pi0_)),
      deltaEffBs2Dst0Kst0_D0pi0_(
          ("deltaEffBs2Dst0Kst0_D0pi0_" +
           ComposeName(uniqueId_, Neutral::gamma))
              .c_str(),
          "", "(@0*@1)+((1-@0)*@2)",
          RooArgSet(*fracKst0_Bs2Dst0Kpi_, *deltaEffBs2Dst0Kst0_res_D0pi0_,
                    *deltaEffBs2Dst0Kpi_D0pi0_)),
      buEffBs2Dst0Kst0_D0pi0_(
          ("buEffBs2Dst0Kst0_D0pi0_" + ComposeName(uniqueId_, Neutral::gamma))
              .c_str(),
          "", "(@0*@1)+((1-@0)*@2)",
          RooArgSet(*fracKst0_Bs2Dst0Kpi_, *buEffBs2Dst0Kst0_res_D0pi0_,
                    *buEffBs2Dst0Kpi_D0pi0_)),
      buPartialEffBs2Dst0Kst0_D0pi0_(
          ("buPartialEffBs2Dst0Kst0_D0pi0_" +
           ComposeName(uniqueId_, Neutral::gamma))
              .c_str(),
          "", "(@0*@1)+((1-@0)*@2)",
          RooArgSet(*fracKst0_Bs2Dst0Kpi_, *buPartialEffBs2Dst0Kst0_res_D0pi0_,
                    *buPartialEffBs2Dst0Kpi_D0pi0_)),
      // -------------------- Bs2Dst0Kst0_D0gamma -------------------- //
      ...
      Bs2Dst0Kst0_D0gamma_meanBu_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0gamma_meanBu", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0gamma, Systematic::NA, Sign::same)),
      Bs2Dst0Kst0_D0gamma_sigmaBu_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0gamma_sigmaBu", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0gamma, Systematic::NA, Sign::same)),
      Bs2Dst0Kst0_D0gamma_a1Bu_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0gamma_a1Bu", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0gamma, Systematic::NA, Sign::none)),
      Bs2Dst0Kst0_D0gamma_n1Bu_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0gamma_n1Bu", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0gamma, Systematic::NA, Sign::none)),
      Bs2Dst0Kst0_D0gamma_a2Bu_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0gamma_a2Bu", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0gamma, Systematic::NA, Sign::none)),
      Bs2Dst0Kst0_D0gamma_n2Bu_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0gamma_n2Bu", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0gamma, Systematic::NA, Sign::none)),
      Bs2Dst0Kst0_D0gamma_fracPdf1Bu_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0gamma_fracPdf1Bu", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0gamma, Systematic::NA, Sign::none)),
      ...
      orEffBs2Dst0Kst0_res_D0gamma_(Params::Get().CreateFixed(
          "orEffBs2Dst0Kst0_res_D0gamma", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma, Bachelor::k,
                        Efficiency::orEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma, Bachelor::k,
                        Efficiency::orEffErr, false),
          Systematic::NA, Sign::same)),
      deltaEffBs2Dst0Kst0_res_D0gamma_(Params::Get().CreateFixed(
          "deltaEffBs2Dst0Kst0_res_D0gamma", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma, Bachelor::k,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma, Bachelor::k,
                        Efficiency::deltaEffErr, false),
          Systematic::NA, Sign::same)),
      buEffBs2Dst0Kst0_res_D0gamma_(Params::Get().CreateFixed(
          "buEffBs2Dst0Kst0_res_D0gamma", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma, Bachelor::k,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma, Bachelor::k,
                        Efficiency::buEffErr, false),
          Systematic::NA, Sign::same)),
      buPartialEffBs2Dst0Kst0_res_D0gamma_(Params::Get().CreateFixed(
          "buPartialEffBs2Dst0Kst0_res_D0gamma", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma, Bachelor::k,
                        Efficiency::buPartialEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma, Bachelor::k,
                        Efficiency::buPartialEffErr, false),
          Systematic::NA, Sign::same)),
      // mcEff_Bs2Dst0Kpi_D0gamma_(Params::Get().CreateFixed(
      //     "mcEff_Bs2Dst0Kpi_D0gamma", uniqueId_, Neutral::gamma,
      //     ReturnMCEffs(Mode::Bs2Dst0Kpi_D0gamma, Neutral::gamma, Bachelor::k,
      //                  Efficiency::mcEff),
      //     ReturnMCEffs(Mode::Bs2Dst0Kpi_D0gamma, Neutral::gamma, Bachelor::k,
      //                  Efficiency::mcEffErr),
      //     Systematic::NA, Sign::same)),
      orEffBs2Dst0Kpi_D0gamma_(Params::Get().CreateFixed(
          "orEffBs2Dst0Kpi_D0gamma", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0gamma, Bachelor::k,
                        Efficiency::orEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0gamma, Bachelor::k,
                        Efficiency::orEffErr, false),
          Systematic::NA, Sign::same)),
      deltaEffBs2Dst0Kpi_D0gamma_(Params::Get().CreateFixed(
          "deltaEffBs2Dst0Kpi_D0gamma", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0gamma, Bachelor::k,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0gamma, Bachelor::k,
                        Efficiency::deltaEffErr, false),
          Systematic::NA, Sign::same)),
      buEffBs2Dst0Kpi_D0gamma_(Params::Get().CreateFixed(
          "buEffBs2Dst0Kpi_D0gamma", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0gamma, Bachelor::k,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0gamma, Bachelor::k,
                        Efficiency::buEffErr, false),
          Systematic::NA, Sign::same)),
      buPartialEffBs2Dst0Kpi_D0gamma_(Params::Get().CreateFixed(
          "buPartialEffBs2Dst0Kpi_D0gamma", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0gamma, Bachelor::k,
                        Efficiency::buPartialEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kpi_D0gamma, Bachelor::k,
                        Efficiency::buPartialEffErr, false),
      ...
      //         .c_str(),
      //     "", "(@0*@1)+((1-@0)*@2)",
      //     RooArgSet(*fracKst0_Bs2Dst0Kpi_, *mcEff_Bs2Dst0Kst0_res_D0gamma_,
      //               *mcEff_Bs2Dst0Kpi_D0gamma_)),
      orEffBs2Dst0Kst0_D0gamma_(
          ("orEffBs2Dst0Kst0_D0gamma_" + ComposeName(uniqueId_, Neutral::gamma))
              .c_str(),
          "", "(@0*@1)+((1-@0)*@2)",
          RooArgSet(*fracKst0_Bs2Dst0Kpi_, *orEffBs2Dst0Kst0_res_D0gamma_,
                    *orEffBs2Dst0Kpi_D0gamma_)),
      deltaEffBs2Dst0Kst0_D0gamma_(
          ("deltaEffBs2Dst0Kst0_D0gamma_" +
           ComposeName(uniqueId_, Neutral::gamma))
              .c_str(),
          "", "(@0*@1)+((1-@0)*@2)",
          RooArgSet(*fracKst0_Bs2Dst0Kpi_, *deltaEffBs2Dst0Kst0_res_D0gamma_,
                    *deltaEffBs2Dst0Kpi_D0gamma_)),
      buEffBs2Dst0Kst0_D0gamma_(
          ("buEffBs2Dst0Kst0_D0gamma_" + ComposeName(uniqueId_, Neutral::gamma))
              .c_str(),
          "", "(@0*@1)+((1-@0)*@2)",
          RooArgSet(*fracKst0_Bs2Dst0Kpi_, *buEffBs2Dst0Kst0_res_D0gamma_,
                    *buEffBs2Dst0Kpi_D0gamma_)),
      buPartialEffBs2Dst0Kst0_D0gamma_(
          ("buPartialEffBs2Dst0Kst0_D0gamma_" +
           ComposeName(uniqueId_, Neutral::gamma))
              .c_str(),
          "", "(@0*@1)+((1-@0)*@2)",
          RooArgSet(*fracKst0_Bs2Dst0Kpi_,
                    *buPartialEffBs2Dst0Kst0_res_D0gamma_,
                    *buPartialEffBs2Dst0Kpi_D0gamma_)),
      // -------------------- Bs2Dst0Kst0_comb -------------------- //
      ...
      Bs2Dst0Kst0_D0pi0_WN_thresholdDelta_(Params::Get().CreateFixed(
          ...
          Mode::Bu2Dst0pi_D0pi0_WN, Systematic::Bs2Dst0Kst0_WN, Sign::same)),
      Bs2Dst0Kst0_D0pi0_WN_cDelta_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0pi0_WN_cDelta", uniqueId_, Neutral::gamma,
          Mode::Bu2Dst0pi_D0pi0_WN, Systematic::Bs2Dst0Kst0_WN, Sign::same)),
      Bs2Dst0Kst0_D0pi0_WN_meanBu_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0pi0_WN_meanBu", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0pi0_WN, Systematic::Bs2Dst0Kst0_WN, Sign::same)),
      Bs2Dst0Kst0_D0pi0_WN_sigmaBu_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0pi0_WN_sigmaBu", uniqueId_, Neutral::gamma,
          Mode::Bs2Dst0Kst0_D0pi0_WN, Systematic::Bs2Dst0Kst0_WN, Sign::same)),
      ...
      orEffBs2Dst0Kst0_D0pi0_WN_(Params::Get().CreateFixed(
          "orEffBs2Dst0Kst0_D0pi0_WN", uniqueId_, Neutral::gamma,
      ...
      deltaEffBs2Dst0Kst0_D0pi0_WN_(Params::Get().CreateFixed(
          "deltaEffBs2Dst0Kst0_D0pi0_WN", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0_WN, Bachelor::k,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0_WN, Bachelor::k,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBs2Dst0Kst0_D0pi0_WN_(Params::Get().CreateFixed(
          "buEffBs2Dst0Kst0_D0pi0_WN", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0_WN, Bachelor::k,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0_WN, Bachelor::k,
                        Efficiency::buEffErr, false),
      ...
      buPartialEffBs2Dst0Kst0_D0pi0_WN_(Params::Get().CreateFixed(
          "buPartialEffBs2Dst0Kst0_D0pi0_WN", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0_WN, Bachelor::k,
                        Efficiency::buPartialEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0pi0_WN, Bachelor::k,
                        Efficiency::buPartialEffErr, false),
      ...
      Bs2Dst0Kst0_D0gamma_WN_thresholdDelta_(Params::Get().CreateFixed(
          ...
          Mode::Bu2Dst0pi_D0gamma_WN, Systematic::Bs2Dst0Kst0_WN, Sign::same)),
      Bs2Dst0Kst0_D0gamma_WN_aDelta_(Params::Get().CreateFixed(
          "Bs2Dst0Kst0_D0gamma_WN_aDelta", uniqueId_, Neutral::gamma,
          Mode::Bu2Dst0pi_D0gamma_WN, Systematic::Bs2Dst0Kst0_WN, Sign::none)),
      ...
      Bs2Dst0Kst0_D0gamma_WN_meanBu_(Params::Get().CreateFixed(
          ...
          Mode::Bs2Dst0Kst0_D0gamma_WN, Systematic::Bs2Dst0Kst0_WN,
          Sign::same)),
      ...
      orEffBs2Dst0Kst0_D0gamma_WN_(Params::Get().CreateFixed(
          "orEffBs2Dst0Kst0_D0gamma_WN", uniqueId_, Neutral::gamma,
      ...
      deltaEffBs2Dst0Kst0_D0gamma_WN_(Params::Get().CreateFixed(
          "deltaEffBs2Dst0Kst0_D0gamma_WN", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma_WN, Bachelor::k,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma_WN, Bachelor::k,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBs2Dst0Kst0_D0gamma_WN_(Params::Get().CreateFixed(
          "buEffBs2Dst0Kst0_D0gamma_WN", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma_WN, Bachelor::k,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma_WN, Bachelor::k,
                        Efficiency::buEffErr, false),
      ...
      buPartialEffBs2Dst0Kst0_D0gamma_WN_(Params::Get().CreateFixed(
          "buPartialEffBs2Dst0Kst0_D0gamma_WN", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma_WN, Bachelor::k,
                        Efficiency::buPartialEff, false),
          ReturnBoxEffs(Mode::Bs2Dst0Kst0_D0gamma_WN, Bachelor::k,
                        Efficiency::buPartialEffErr, false),
      ...
      orEffBu2Dst0h_D0gamma_D02pik_(Params::Get().CreateFixed(
          "orEffBu2Dst0h_D0gamma_D02pik", uniqueId_, Neutral::gamma,
      ...
      deltaEffBu2Dst0h_D0gamma_D02pik_(Params::Get().CreateFixed(
          "deltaEffBu2Dst0h_D0gamma_D02pik", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma_D02pik, Bachelor::pi,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma_D02pik, Bachelor::pi,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBu2Dst0h_D0gamma_D02pik_(Params::Get().CreateFixed(
          "buEffBu2Dst0h_D0gamma_D02pik", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma_D02pik, Bachelor::pi,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma_D02pik, Bachelor::pi,
                        Efficiency::buEffErr, false),
      ...
      buPartialEffBu2Dst0h_D0gamma_D02pik_(Params::Get().CreateFixed(
          "buPartialEffBu2Dst0h_D0gamma_D02pik", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma_D02pik, Bachelor::pi,
                        Efficiency::buPartialEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma_D02pik, Bachelor::pi,
                        Efficiency::buPartialEffErr, false),
      ...
      orEffBu2Dst0h_D0pi0_D02pik_(Params::Get().CreateFixed(
          "orEffBu2Dst0h_D0pi0_D02pik", uniqueId_, Neutral::gamma,
      ...
      deltaEffBu2Dst0h_D0pi0_D02pik_(Params::Get().CreateFixed(
          "deltaEffBu2Dst0h_D0pi0_D02pik", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_D02pik, Bachelor::pi,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_D02pik, Bachelor::pi,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBu2Dst0h_D0pi0_D02pik_(Params::Get().CreateFixed(
          "buEffBu2Dst0h_D0pi0_D02pik", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_D02pik, Bachelor::pi,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_D02pik, Bachelor::pi,
                        Efficiency::buEffErr, false),
      ...
      buPartialEffBu2Dst0h_D0pi0_D02pik_(Params::Get().CreateFixed(
          "buPartialEffBu2Dst0h_D0pi0_D02pik", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_D02pik, Bachelor::pi,
                        Efficiency::buPartialEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_D02pik, Bachelor::pi,
                        Efficiency::buPartialEffErr, false),
      ...
      orEffBu2Dst0h_D0gamma_WN_D02pik_(Params::Get().CreateFixed(
          "orEffBu2Dst0h_D0gamma_WN_D02pik", uniqueId_, Neutral::gamma,
      ...
      deltaEffBu2Dst0h_D0gamma_WN_D02pik_(Params::Get().CreateFixed(
          "deltaEffBu2Dst0h_D0gamma_WN_D02pik", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma_WN_D02pik, Bachelor::pi,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma_WN_D02pik, Bachelor::pi,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBu2Dst0h_D0gamma_WN_D02pik_(Params::Get().CreateFixed(
          "buEffBu2Dst0h_D0gamma_WN_D02pik", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma_WN_D02pik, Bachelor::pi,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma_WN_D02pik, Bachelor::pi,
                        Efficiency::buEffErr, false),
      ...
      buPartialEffBu2Dst0h_D0gamma_WN_D02pik_(Params::Get().CreateFixed(
          "buPartialEffBu2Dst0h_D0gamma_WN_D02pik", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma_WN_D02pik, Bachelor::pi,
                        Efficiency::buPartialEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0gamma_WN_D02pik, Bachelor::pi,
                        Efficiency::buPartialEffErr, false),
      ...
      orEffBu2Dst0h_D0pi0_WN_D02pik_(Params::Get().CreateFixed(
          "orEffBu2Dst0h_D0pi0_WN_D02pik", uniqueId_, Neutral::gamma,
      ...
      deltaEffBu2Dst0h_D0pi0_WN_D02pik_(Params::Get().CreateFixed(
          "deltaEffBu2Dst0h_D0pi0_WN_D02pik", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_WN_D02pik, Bachelor::pi,
                        Efficiency::deltaEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_WN_D02pik, Bachelor::pi,
                        Efficiency::deltaEffErr, false),
      ...
      buEffBu2Dst0h_D0pi0_WN_D02pik_(Params::Get().CreateFixed(
          "buEffBu2Dst0h_D0pi0_WN_D02pik", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_WN_D02pik, Bachelor::pi,
                        Efficiency::buEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_WN_D02pik, Bachelor::pi,
                        Efficiency::buEffErr, false),
      ...
      buPartialEffBu2Dst0h_D0pi0_WN_D02pik_(Params::Get().CreateFixed(
          "buPartialEffBu2Dst0h_D0pi0_WN_D02pik", uniqueId_, Neutral::gamma,
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_WN_D02pik, Bachelor::pi,
                        Efficiency::buPartialEff, false),
          ReturnBoxEffs(Mode::Bu2Dst0pi_D0pi0_WN_D02pik, Bachelor::pi,
                        Efficiency::buPartialEffErr, false),
      ...
      bkgFracFAV_Bu2Dst0hst_(Params::Get().CreateFloating(
          "bkgFracFAV_Bu2Dst0hst", uniqueId_, Neutral::gamma,
          ReadBkgFracs<Neutral::gamma>(Mode::Bu2Dst0rho, ReturnType::val), 0,
          5)),
