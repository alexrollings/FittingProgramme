...
NeutralBachelorVars<Neutral::pi0, Bachelor::pi>::NeutralBachelorVars(
    ...
    : Bu2Dst0h_D0gamma_sigmaBu_(
      ...
      N_MisRec_(
          ("N_MisRec_" + ComposeName(uniqueId, Neutral::pi0, Bachelor::pi))
              .c_str(),
          "",
      ...
      N_Bu2D0h_(
          ("N_Bu2D0h_" + ComposeName(uniqueId, Neutral::pi0, Bachelor::pi))
              .c_str(),
  ...
  if (Configuration::Get().fit1D() == false) {
    ...
    N_BuDelta_Bu2Dst0h_D0gamma_ = std::unique_ptr<RooRealVar>(
        new RooRealVar(("N_BuDelta_Bu2Dst0h_D0gamma_" +
                        ComposeName(uniqueId, Neutral::pi0, Bachelor::pi))
                           .c_str(),
                       "", NeutralVars<Neutral::pi0>::Get(uniqueId)
                                   .initYieldFAVBu2Dst0pi_D0gamma() *
