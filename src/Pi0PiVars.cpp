...
NeutralBachelorVars<Neutral::pi0, Bachelor::pi>::NeutralBachelorVars(
    ...
    : uniqueId_(uniqueId),
      ...
      orEffBd2Dsth_(Params::Get().CreateFixed(
          ...
          ReturnBoxEffs(Mode::Bd2DstK, Bachelor::pi, Efficiency::orEff,
          false), ReturnBoxEffs(Mode::Bd2DstK, Bachelor::pi,
          Efficiency::orEffErr,
                        false),
      ...
      orEffBu2D0hst_(Params::Get().CreateFixed(
          ...
          ReturnBoxEffs(Mode::Bu2D0Kst, Bachelor::pi, Efficiency::orEff,
          false), ReturnBoxEffs(Mode::Bu2D0Kst, Bachelor::pi,
          Efficiency::orEffErr,
                        false),
      ...
      buEffBd2Dsth_(Params::Get().CreateFixed(
          ...
          ReturnBoxEffs(Mode::Bd2DstK, Bachelor::pi, Efficiency::buEff,
          false), ReturnBoxEffs(Mode::Bd2DstK, Bachelor::pi,
          Efficiency::buEffErr,
                        false),
          Systematic::boxEffs_Bd2Dsth, Sign::same,
      ...
      buEffBu2D0hst_(Params::Get().CreateFixed(
          ...
          ReturnBoxEffs(Mode::Bu2D0Kst, Bachelor::pi, Efficiency::buEff,
          false), ReturnBoxEffs(Mode::Bu2D0Kst, Bachelor::pi,
          Efficiency::buEffErr,
                        false),
          Systematic::boxEffs_Bu2D0hst, Sign::same,
