...
R_pi0_CP = (pi0_DK_hh_minus + pi0_DK_hh_plus)/((pi0_Dpi_hh_minus + pi0_Dpi_hh_plus)*R_DstKDstpi)
R_gamma_CP = (gamma_DK_hh_minus + gamma_DK_hh_plus)/((gamma_Dpi_hh_minus + gamma_Dpi_hh_plus)*R_DstKDstpi)
...
plt.clf()
fig = plt.hist(rB_Dpi, 100, density=True)
plt.savefig('gamma_obs/rB_Dpi.png')
plt.clf()
fig = plt.hist(dB_Dpi, 100, density=True)
plt.savefig('gamma_obs/dB_Dpi.png')
plt.clf()
fig = plt.hist(rB_DK, 100, density=True)
plt.savefig('gamma_obs/rB_DK.png')
plt.clf()
fig = plt.hist(dB_DK, 100, density=True)
plt.savefig('gamma_obs/dB_DK.png')
plt.clf()
fig = plt.hist(R_DstKDstpi, 100, density=True)
plt.savefig('gamma_obs/R_DstKDstpi.png')
plt.clf()
fig = plt.hist(A_gamma_Dpi_kpi, 100, density=True)
plt.savefig('gamma_obs/A_gamma_Dpi_kpi.png')
plt.clf()
fig = plt.hist(A_gamma_DK_kpi, 100, density=True)
plt.savefig('gamma_obs/A_gamma_DK_kpi.png')
plt.clf()
fig = plt.hist(A_gamma_Dpi_CP, 100, density=True)
plt.savefig('gamma_obs/A_gamma_Dpi_CP.png')
plt.clf()
fig = plt.hist(A_gamma_DK_CP, 100, density=True)
plt.savefig('gamma_obs/A_gamma_DK_CP.png')
plt.clf()
fig = plt.hist(R_gamma_CP, 100, density=True)
plt.savefig('gamma_obs/R_gamma_CP.png')
plt.clf()
fig = plt.hist(R_gamma_Dpi_pik_minus, 100, density=True)
plt.savefig('gamma_obs/R_gamma_Dpi_pik_minus.png')
plt.clf()
fig = plt.hist(R_gamma_Dpi_pik_plus, 100, density=True)
plt.savefig('gamma_obs/R_gamma_Dpi_pik_plus.png')
plt.clf()
fig = plt.hist(R_gamma_Dpi_pik, 100, density=True)
plt.savefig('gamma_obs/R_gamma_Dpi_pik.png')
plt.clf()
fig = plt.hist(A_gamma_Dpi_pik, 100, density=True)
plt.savefig('gamma_obs/A_gamma_Dpi_pik.png')
plt.clf()
fig = plt.hist(R_gamma_DK_pik_minus, 100, density=True)
plt.savefig('gamma_obs/R_gamma_DK_pik_minus.png')
plt.clf()
fig = plt.hist(R_gamma_DK_pik_plus, 100, density=True)
plt.savefig('gamma_obs/R_gamma_DK_pik_plus.png')
plt.clf()
fig = plt.hist(R_gamma_DK_pik, 100, density=True)
plt.savefig('gamma_obs/R_gamma_DK_pik.png')
plt.clf()
fig = plt.hist(A_gamma_DK_pik, 100, density=True)
