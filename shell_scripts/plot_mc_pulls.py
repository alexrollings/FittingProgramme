...
if __name__ == "__main__":
  ...
  templatePath = home_path + 'shell_scripts/plot_mc_pulls.sh.tmpl'
  ...
  for neutral in neutrals:
    ...
    for box in split:
      ...
      scriptPath = '/home/rollings/Bu2Dst0h_2d/FittingProgramme/shell_scripts/tmp/plot_mc_pulls_' + neutral + "_" + delta_low + "_" + delta_high + "_" + bu_low + "_" + bu_high + ".sh"
      substitutions = {
      ...
      if queue == 'batch':
        ...
        submitTemplate = home_path + 'shell_scripts/plot_mc_pulls_submit.sh.tmpl'
        submitScript = "/home/rollings/Bu2Dst0h_2d/FittingProgramme/shell_scripts/tmp/plot_mc_pulls_" + neutral + "_" + delta_low + "_" + delta_high + "_" + bu_low + "_" + bu_high + ".submit"
        submitSubs = {
            "NEUTRAL": neutral,
            "DL": delta_low,
            "DH": delta_high,
