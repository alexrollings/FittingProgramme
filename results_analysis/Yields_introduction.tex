...
\begin{itemize}
  ...
  \item The $B^{\pm}\rightarrow (D^*\rightarrow D\gamma(\pi^0))\rho^{\pm}$
    ...
    D^{*\pm}\pi^{\mp})}$} \times
    \colorbox{pink}{$\frac{\epsilon_{cross}(B^{\pm}\rightarrow (D^*\rightarrow
    D\gamma(\pi^0))\rho^{\pm})}{\epsilon_{cross}(B^0\rightarrow
    D^{*\pm}\pi^{\mp})}$}
  \end{equation*}
  In the $D\gamma(D\pi^0)$ fit, the $D\pi^0(D\gamma)$ component of this decay is
  constrained relative to the $D\gamma(D\pi^0)$ component (calculated above):
    \begin{equation*}
      \colorbox{green!35}{\text{N($B^{\pm}\rightarrow (D^*\rightarrow
      ...
      \colorbox{pink}{$\frac{\epsilon_{sel}(B^{\pm}\rightarrow (D^*\rightarrow
    D\pi^0(D\gamma))\rho^{\pm})}{\epsilon_{sel}(B^{\pm}\rightarrow (D^*\rightarrow
    D\gamma(\pi^0))\rho^{\pm})}$} \times
    \colorbox{pink}{$\frac{\epsilon_{cross}(B^{\pm}\rightarrow (D^*\rightarrow
    D\pi^0(D\gamma))\rho^{\pm})}{\epsilon_{cross}(B^{\pm}\rightarrow
    (D^*\rightarrow D\gamma(\pi^0))\rho^{\pm})}$} \end{equation*}
    ...
    selection, box efficiencies and branching fractions.
