...
if __name__ == "__main__":
  ...
  filename = 'list_file_' + neutral
  if delta_partial_low != None or delta_partial_high != None:
    filename += "_" + delta_partial_low + "_" + delta_partial_high
  filename += "_" + delta_low + "_" + delta_high
  if bu_low != None or bu_high != None:
    filename += "_" + bu_low + "_" + bu_high
  filename += '.txt'
    ...
    if dim == "1D":
      if fit_bu_partial == False:
        subprocess.call([
            ...
            "-inputFile=" + filename, "-outputDir=" + output_dir, "-1D",
            "-toyInit=" + toy_init
        ])
      else:
        subprocess.call([
