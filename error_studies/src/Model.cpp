...
Model::Model(Configuration &config, int _uniqueId)
    : uniqueId(_uniqueId),
      ...
      buSigma(("buSigma_" + std::to_string(uniqueId)).c_str(), "", 2.2420e+01),
      buA1(("buA1_" + std::to_string(uniqueId)).c_str(), "", 4.3526e+00),
      buN1(("buN1_" + std::to_string(uniqueId)).c_str(), "", 10),
      buA2(("buA2_" + std::to_string(uniqueId)).c_str(), "", -1.6871e+00),
      buN2(("buN2_" + std::to_string(uniqueId)).c_str(), "", 10),
      buFrac(("buFrac_" + std::to_string(uniqueId)).c_str(), "", 7.6254e-01),
      // m(B): 5170 - 5220
      // buMean(("buMean_" + std::to_string(uniqueId)).c_str(), "", 5.2728e+03),
      // buSigma(("buSigma_" + std::to_string(uniqueId)).c_str(), "", 2.2356e+01),
      // buA1(("buA1_" + std::to_string(uniqueId)).c_str(), "", 4.3526e+00),
      // buN1(("buN1_" + std::to_string(uniqueId)).c_str(), "", 10),
      // buA2(("buA2_" + std::to_string(uniqueId)).c_str(), "", -1.6871e+00),
      // buN2(("buN2_" + std::to_string(uniqueId)).c_str(), "", 10),
      // buFrac(("buFrac_" + std::to_string(uniqueId)).c_str(), "", 8.3599e-01),
      ...
      // deltaA2(("deltaA2_" + std::to_string(uniqueId)).c_str(), "", -1, -5, -0.00001),
      // deltaN2(("deltaN2_" + std::to_string(uniqueId)).c_str(), "", 10),
      // deltaFrac(("deltaFrac_" + std::to_string(uniqueId)).c_str(), "", 0.5, 0,
      //           1),
      // m(B): 5170 - 5370
      deltaMean(("deltaMean_" + std::to_string(uniqueId)).c_str(), "", 1.4239e+02),
      deltaSigma(("deltaSigma_" + std::to_string(uniqueId)).c_str(), "", 1.6248e+00),
      deltaA1(("deltaA1_" + std::to_string(uniqueId)).c_str(), "", 9.2873e-01),
      deltaN1(("deltaN1_" + std::to_string(uniqueId)).c_str(), "", 10),
      deltaA2(("deltaA2_" + std::to_string(uniqueId)).c_str(), "", -6.5084e-01),
      deltaN2(("deltaN2_" + std::to_string(uniqueId)).c_str(), "", 10),
      deltaFrac(("deltaFrac_" + std::to_string(uniqueId)).c_str(), "", 1.7763e-01),
      // m(B): 5170 - 5220
      // deltaMean(("deltaMean_" + std::to_string(uniqueId)).c_str(), "", 1.4248e+02),
      // deltaSigma(("deltaSigma_" + std::to_string(uniqueId)).c_str(), "", 2.7309e+00),
      // deltaA1(("deltaA1_" + std::to_string(uniqueId)).c_str(), "", 3.4291e+00),
      // deltaN1(("deltaN1_" + std::to_string(uniqueId)).c_str(), "", 10),
      // deltaA2(("deltaA2_" + std::to_string(uniqueId)).c_str(), "", -4.5894e+00),
      // deltaN2(("deltaN2_" + std::to_string(uniqueId)).c_str(), "", 10),
      // deltaFrac(("deltaFrac_" + std::to_string(uniqueId)).c_str(), "", 9.7755e-01),
      ...
      // buBkgMean(("buBkgMean_" + std::to_string(uniqueId)).c_str(), "", 5.2445e+03, 5235, 5255),
      // buBkgSigma(("buBkgSigma_" + std::to_string(uniqueId)).c_str(), "", 8.5073e+01, 75, 95),
      // m(B): 5170 - 5370
      buBkgMean(("buBkgMean_" + std::to_string(uniqueId)).c_str(), "", 5.2466e+03),
      buBkgSigma(("buBkgSigma_" + std::to_string(uniqueId)).c_str(), "", 8.1571e+01),
      // m(B): 5170 - 5220
      // buBkgMean(("buBkgMean_" + std::to_string(uniqueId)).c_str(), "", 5.2474e+03),
      // buBkgSigma(("buBkgSigma_" + std::to_string(uniqueId)).c_str(), "", 8.0989e+01),
      buBkgPdf(("buBkgPdf_" + std::to_string(uniqueId)).c_str(), "",
               config.buMass, buBkgMean, buBkgSigma),
      deltaBkgThreshold(("deltaBkgThreshold_" + std::to_string(uniqueId)).c_str(), "", 1.3406e+02),
      deltaBkgC(("deltaBkgC_" + std::to_string(uniqueId)).c_str(), "", 1.0052e+01),
      // deltaBkgA(("deltaBkgA_" + std::to_string(uniqueId)).c_str(), "", -2.4211e+00, -5, 5),
      // m(B): 5170 - 5370
      deltaBkgA(("deltaBkgA_" + std::to_string(uniqueId)).c_str(), "", -4.6769e+00),
      // 5170 - 5220
      // deltaBkgA(("deltaBkgA_" + std::to_string(uniqueId)).c_str(), "", -3.2607e+00),
      deltaBkgB(("deltaBkgB_" + std::to_string(uniqueId)).c_str(), "", 2.6138e-01),
      deltaBkgPdf(("deltaBkgPdf_" + std::to_string(uniqueId)).c_str(), "",
