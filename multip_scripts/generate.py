...
def run_process(script):
  ...
  with open(
      '/home/rollings/Bu2Dst0h_2d/FittingProgramme/tmp/' +
...
if __name__ == "__main__":
  ...
  for i in range(0, n_jobs):
    if gen == "model":
      ...
      if neutral == "pi0":
        scriptPath = '/home/rollings/Bu2Dst0h_2d/FittingProgramme/tmp/generate_from_model_' + neutral + "_" + delta_low + "_" + delta_high + "_" + bu_low + "_" + bu_high + "_" + str(
            i) + ".sh"
      else:
        scriptPath = '/home/rollings/Bu2Dst0h_2d/FittingProgramme/tmp/generate_from_model_' + neutral + "_" + delta_low + "_" + delta_high + "_" + delta_partial_low + "_" + delta_partial_high + "_" + bu_low + "_" + bu_high + "_" + str(
            i) + ".sh"
      substitutions = {
          "nJob": i,
          "INPUT": input_dir,
      ...
      if neutral == "pi0":
        scriptPath = '/home/rollings/Bu2Dst0h_2d/FittingProgramme/tmp/generate_from_data_' + neutral + "_" + delta_low + "_" + delta_high + "_" + bu_low + "_" + bu_high + "_" + str(
            i) + ".sh"
      else:
        scriptPath = '/home/rollings/Bu2Dst0h_2d/FittingProgramme/tmp/generate_from_data_' + neutral + "_" + delta_low + "_" + delta_high + "_" + delta_partial_low + "_" + delta_partial_high + "_" + bu_low + "_" + bu_high + "_" + str(
            i) + ".sh"
      substitutions = {
          "nJob": i,
          "PATH": output_dir,
