...
if __name__ == "__main__":
    ...
    # Returns numbers with the correct uncertainties and correlations, given the covariance matric
        ...
        obs[dim + "_N_frac_box_Bu2Dst0h_D0gamma_gamma_pi_0"] = obs[
            dim + "_N_box_Bu2Dst0h_D0gamma_gamma_pi_0"] / obs[
                dim + "_N_Bu2Dst0h_D0gamma_gamma_pi_0_corr"]
        obs[dim + "_N_box_Bu2Dst0h_D0gamma_gamma_k_0"] = yield_box_k
        obs[dim + "_N_frac_box_Bu2Dst0h_D0gamma_gamma_k_0"] = obs[
            dim + "_N_box_Bu2Dst0h_D0gamma_gamma_k_0"] / obs[
                dim + "_N_Bu2Dst0h_D0gamma_gamma_k_0_corr"]
    ...
    plt.errorbar(unumpy.nominal_values(frac_yields_k),
                 np.divide(unumpy.std_devs(yields_k),
                           unumpy.nominal_values(yields_k))*100,
