...
class NeutralBachelorChargeVars {
 public:
  ...
  // -------------------- Bu2Dst0h_D0gamma -------------------- //
  RooRealVar &N_tot_Bu2Dst0h_D0gamma() { return *impl_.N_tot_Bu2Dst0h_D0gamma_; }
  ...
  RooAbsReal &N_BuPartial_Bu2Dst0h_D0gamma() { return *impl_.N_BuPartial_Bu2Dst0h_D0gamma_; }
  // -------------------- Mis-ID ------------------- //
  // -------------------- Bu2Dst0h_D0pi0 -------------------- //
  ...
  RooAbsReal &N_BuPartial_Bu2Dst0h_D0pi0() { return *impl_.N_BuPartial_Bu2Dst0h_D0pi0_; }
  // -------------------- Mis-ID ------------------- //
  // -------------------- MIS-REC -------------------- //
  ...
  RooFormulaVar &N_Delta_PartRec() {
    return *impl_.N_Delta_PartRec_;
  }
  RooAbsReal &N_Bu_PartRec() {
    return *impl_.N_Bu_PartRec_;
  }
