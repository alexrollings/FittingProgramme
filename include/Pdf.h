...
class PdfBase {
 public:
  ...
  virtual RooFormulaVar &N_trueId_Bu_comb() const = 0;
  ...
  virtual RooAbsReal &N_trueId_Delta_comb() const = 0;
  ...
  virtual RooFormulaVar &N_trueId_BuPartial_Bu2Dst0h_D0pi0_WN_D02pik()
      const = 0;
  virtual RooFormulaVar &N_trueId_BuPartial_comb() const = 0;
  ...
  virtual RooAddPdf &pdfDelta_comb() const = 0;
  ...
  virtual RooAbsPdf &pdfDelta_misId_Bd2Dsth() const = 0;
  virtual RooAbsPdf &pdfDelta_misId_Bu2D0hst() const = 0;
  ...
  virtual RooAbsPdf &pdfBu_Bs2D0Kst0() const = 0;
  ...
  virtual RooGaussian &pdfBu_comb() const = 0;
  ...
  virtual RooAddPdf &pdfBuPartial_Bu2Dst0h_D0gamma_WN() const = 0;
  ...
  virtual RooGaussian &pdfBuPartial_comb() const = 0;
  ...
  virtual RooAbsPdf &pdfBuPartial_misId_Bd2Dsth() const = 0;
...
class Pdf : public PdfBase {
 ...
 public:
  ...
  virtual RooFormulaVar &N_trueId_Bu_comb() const {
    return Yields<_neutral, _bachelor, _daughters, _charge>::Get(uniqueId_)
        .N_trueId_Bu_comb();
  }
  ...
  virtual RooAbsReal &N_trueId_Delta_comb() const {
    return Yields<_neutral, _bachelor, _daughters, _charge>::Get(uniqueId_)
        .N_trueId_Delta_comb();
  }
  ...
  virtual RooFormulaVar &N_trueId_BuPartial_comb() const {
    return Yields<_neutral, _bachelor, _daughters, _charge>::Get(uniqueId_)
  ...
  virtual RooAddPdf &pdfDelta_comb() const {
    return NeutralBachelorVars<_neutral, _bachelor>::Get(uniqueId_)
        .pdfDelta_comb();
  }
  ...
  virtual RooAbsPdf &pdfDelta_misId_Bd2Dsth() const {
    return NeutralBachelorVars<_neutral, _bachelor>::Get(uniqueId_)
        .pdfDelta_misId_Bd2Dsth();
  }
  virtual RooAbsPdf &pdfDelta_misId_Bu2D0hst() const {
    return NeutralBachelorVars<_neutral, _bachelor>::Get(uniqueId_)
  ...
  virtual RooAbsPdf &pdfBu_Bs2D0Kst0() const {
  ...
  virtual RooGaussian &pdfBu_comb() const {
  ...
  virtual RooAddPdf &pdfBuPartial_Bu2Dst0h_D0gamma_WN() const {
    return NeutralBachelorVars<_neutral, _bachelor>::Get(uniqueId_)
  ...
  virtual RooGaussian &pdfBuPartial_comb() const {
    return NeutralVars<_neutral>::Get(uniqueId_).pdfBuPartial_comb();
  }
  ...
  virtual RooAbsPdf &pdfBuPartial_misId_Bd2Dsth() const {
    return NeutralBachelorVars<_neutral, _bachelor>::Get(uniqueId_)
