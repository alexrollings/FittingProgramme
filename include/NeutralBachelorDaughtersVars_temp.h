    ...
    : asym_Bu2Dst0h_Dst02D0gamma_(new RooRealVar(
      ...
      N_Bu2Dst0h_Dst02D0gamma_(new RooRealVar(
          ...
          ("Total number of Bu2Dst0h_Dst02D0gamma-like events " +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 4.056 * 1, 0,
          // Configuration::Get().yieldTot())),70000)),
          16672, 0, 70000)),      N_Bu2Dst0h_Dst02D0pi0_(new RooRealVar(
          ...
          ("Total number of Bu2Dst0h_Dst02D0pi0-like events " +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 4.056 * 0.797, 0,
          // Configuration::Get().yieldTot())),
          13289, 0, 70000)),
      N_overRec_(new RooRealVar(
          ...
          ("Total number of overRec-like events " +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 4.056 * 1.012, 0,
          // Configuration::Get().yieldTot())),
          16866, 0, 70000)),
      N_Bu2Dst0hst_Dst02D0pi0_(new RooRealVar(
          ...
          ("Total number of Bu2Dst0hst_Dst02D0pi0 reconstructed events " +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 4.056 * 0.077, 0,
          // Configuration::Get().yieldTot())),
          1286, 0, 70000)),
      N_Bu2Dst0hst_Dst02D0gamma_(new RooRealVar(
          ...
          ("Total number of Bu2Dst0hst_Dst02D0gamma reconstructed events " +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 4.056 * 0.171, 0,
          // Configuration::Get().yieldTot())),
          2845, 0, 70000)),
      N_Bu2D0hst_(new RooRealVar(
          ("N_Bu2D0hst_" +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::pi, daughters))
              .c_str(),
          ("Total number of Bu2D0hst-like events " +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 4.056 * 0.575, 0,
          // Configuration::Get().yieldTot())),
          9586, 0, 70000)),
      N_Bd2Dsth_(new RooRealVar(
          ...
          ("Total number of Bd2Dsth-like events " +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 4.056 * 0.424, 0,
          // Configuration::Get().yieldTot())) {}
          7068, 0, 70000)) {}
    ...
    : asym_Bu2Dst0h_Dst02D0gamma_(new RooRealVar(
      ...
      N_Bu2Dst0hst_Dst02D0gamma_(new RooFormulaVar(
          ...
          RooArgList(NeutralBachelorDaughtersVars<Neutral::gamma, Bachelor::pi,
                     ...
                     Configuration::Get().pidEff()))),
      N_Bu2D0hst_(new RooFormulaVar(
          ("N_Bu2D0hst_" +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::k, daughters))
              .c_str(),
          ("Total number of Bu2D0hst reconstructed events, "
           "for " +
           ComposeName(uniqueId, Neutral::gamma, Bachelor::k, daughters))
              .c_str(),
          "@0*@1*@2",
    ...
    : asym_Bu2Dst0h_Dst02D0gamma_(new RooRealVar(
      ...
      N_Bu2Dst0h_Dst02D0gamma_(new RooRealVar(
          ...
          ("Total number of Bu2Dst0h_Dst02D0gamma-like events " +
           ComposeName(uniqueId, Neutral::pi0, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 3.732 * 0.197, 0,
          // Configuration::Get().yieldTot())),
          818, 0, 20000)),
      N_Bu2Dst0h_Dst02D0pi0_(new RooRealVar(
          ...
          ("Total number of Bu2Dst0h_Dst02D0pi0-like events " +
           ComposeName(uniqueId, Neutral::pi0, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 3.732 * 1, 0,
          // Configuration::Get().yieldTot())),
          4157, 0, 20000)),
      N_overRec_(new RooRealVar(
          ("N_overRec_" +
          ...
          ("Total number of overRec-like events " +
           ComposeName(uniqueId, Neutral::pi0, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 3.732 * 1.469, 0,
          // Configuration::Get().yieldTot())),
          6107, 0, 20000)),
      N_Bu2Dst0hst_Dst02D0pi0_(new RooRealVar(
          ("N_Bu2Dst0hst_Dst02D0pi0_" +
          ...
          ("Total number of Bu2Dst0hst_Dst02D0pi0 reconstructed events " +
           ComposeName(uniqueId, Neutral::pi0, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 3.732 * 0.281, 0,
          // Configuration::Get().yieldTot())),
          1167, 0, 20000)),
      N_Bu2Dst0hst_Dst02D0gamma_(new RooRealVar(
          ("N_Bu2Dst0hst_Dst02D0gamma_" +
          ...
          ("Total number of Bu2Dst0hst_Dst02D0gamma reconstructed events " +
           ComposeName(uniqueId, Neutral::pi0, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 3.732 * 0.051, 0,
          // Configuration::Get().yieldTot())),
          213, 0, 20000)),
      N_Bu2D0hst_(new RooRealVar(
          ("N_Bu2D0hst_" +
          ...
          ("Total number of Bu2D0hst-like events " +
           ComposeName(uniqueId, Neutral::pi0, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 3.732 * 0.460, 0,
          // Configuration::Get().yieldTot())),
          1911, 0, 20000)),
      N_Bd2Dsth_(new RooRealVar(
          ("N_Bd2Dsth_" +
          ...
          ("Total number of Bd2Dsth-like events " +
           ComposeName(uniqueId, Neutral::pi0, Bachelor::pi, daughters))
              .c_str(),
          // Configuration::Get().yieldTot() / 3.732 * 0.274, 0,
          // Configuration::Get().yieldTot())) {}
          1140, 0, 20000)) {}
