...
class NeutralBachelorVars {
 public:
  ...
  RooGaussian &pdfBu_misId_Bd2Dsth() {
    return pdfBu_misId_Bd2Dsth_;
  }
  RooGaussian &pdfBuPartial_misId_Bd2Dsth() {
  ...
  RooGaussian &pdfBu_misId_Bu2D0hst() {
    return pdfBu_misId_Bu2D0hst_;
  }
  RooGaussian &pdfBuPartial_misId_Bu2D0hst() {
  ...
  RooFormulaVar &Bu2Dst0hst_D0gamma_sigma3Bu() {
    return Bu2Dst0hst_D0gamma_sigma3Bu_;
  }
  ...
  RooGaussian &pdfFlatBu_Bu2Dst0hst_D0gamma() {
    return pdfFlatBu_Bu2Dst0hst_D0gamma_;
  }
 ...
 private:
  ...
  RooGaussian pdfBu_misId_Bd2Dsth_;
  ...
  RooGaussian pdfBuPartial_misId_Bd2Dsth_;
  // -------------------- Bu2D0hst -------------------- //
  ...
  RooGaussian pdfBu_misId_Bu2D0hst_;
  ...
  RooGaussian pdfBuPartial_misId_Bu2D0hst_;
  // -------------------- Bu2Dst0hst_D0gamma -------------------- //
  ...
  std::shared_ptr<RooRealVar> misId_Bu2Dst0hst_D0pi0_meanDelta_;
  std::shared_ptr<RooRealVar> misId_Bu2Dst0hst_D0pi0_sigmaDelta_;
  ...
  std::shared_ptr<RooRealVar> misId_Bu2Dst0hst_D0pi0_fracPdfPeakDelta_;
