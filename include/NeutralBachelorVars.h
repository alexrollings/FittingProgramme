...
class NeutralBachelorVars {
 public:
  ...
  RooAbsReal &N_BuDelta_Bu2Dst0h_D0gamma() {
  ...
  RooAbsReal &N_BuDelta_Bu2Dst0h_D0pi0() {
 ...
 private:
  ...
  std::unique_ptr<RooAbsReal> N_BuDelta_Bu2Dst0h_D0gamma_;
  // -------------------- Bu2Dst0h_D0pi0 -------------------- //
  ...
  std::unique_ptr<RooAbsReal> N_BuDelta_Bu2D0h_;
};
